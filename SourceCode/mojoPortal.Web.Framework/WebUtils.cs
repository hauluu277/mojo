...
namespace mojoPortal.Web.Framework
{
    ...
    public static class WebUtils
    {
        ...
        public static DateTime ParseDateFromQueryString(string paramName, DateTime defaultIfNotFound)
        {
         ...
         public static int? ParseIntOrNullFromQueryString(String paramName, int? defaultIfNotFoundOrInvalid)
        {
            int? paramValue;
        ...
        public static Int64 ParseInt64FromQueryString(String paramName, Int64 defaultIfNotFoundOrInvalid)
        {
            Int64 paramValue;
            if (TryLoadRequestParam(paramName, out paramValue)) return paramValue;
            return defaultIfNotFoundOrInvalid;
        ...
        public static Int32? ParseInt32OrNullFromQueryString(String paramName, Int32? defaultIfNotFoundOrInvalid)
        {
            Int32? paramValue;
            if (TryLoadRequestParam(paramName, out paramValue)) return paramValue;
            return defaultIfNotFoundOrInvalid;
