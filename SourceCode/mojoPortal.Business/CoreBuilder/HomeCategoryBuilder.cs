...
namespace mojoPortal.Business
{
    ...
    public class HomeCategoryBuilder
    {

        #region Constructors

        public HomeCategoryBuilder()
        { }
        ...
        private void GetHomeCategory(
            int itemID)
        {
            using (IDataReader reader = DBHomeCategoryBuilder.GetOne(
                itemID))
            {
        ...
        private bool Create()
        {
            ...
            newID = DBHomeCategoryBuilder.Create(
                this.siteID,
                this.moduleID,
                this.title,
                this.itemUrl,
        ...
        private bool Update()
        {
            ...
            return DBHomeCategoryBuilder.Update(
                this.itemID,
                this.siteID,
                this.moduleID,
                this.title,
        ...
        public static bool Delete(
            int itemID)
        {
            return DBHomeCategoryBuilder.Delete(
                itemID);
        }
        ...
        {
            return DBHomeCategoryBuilder.GetCount(siteID, moduleID);
        }

        private static List<HomeCategoryBuilder> LoadListFromReader(IDataReader reader)
        {
            List<HomeCategoryBuilder> homeCategoryList = new List<HomeCategoryBuilder>();
            try
            {
                while (reader.Read())
                {
                    HomeCategoryBuilder homeCategory = new HomeCategoryBuilder();
        ...
        /// </summary>
        public static List<HomeCategoryBuilder> GetAll()
        {
            IDataReader reader = DBHomeCategoryBuilder.GetAll();
            return LoadListFromReader(reader);

        }

        public static List<HomeCategoryBuilder> GetByModule(int moduleID)
        {
            IDataReader reader = DBHomeCategoryBuilder.GetByModule(moduleID);
            return LoadListFromReader(reader);
        ...
        public static List<HomeCategoryBuilder> GetPage(int siteId, int moduleId, int pageNumber, int pageSize, out int totalPages)
        {
            totalPages = 1;
            IDataReader reader = DBHomeCategoryBuilder.GetPage(siteId, moduleId, pageNumber, pageSize, out totalPages);
            return LoadListFromReader(reader);
        }
        ...
        /// </summary>
        public static int CompareByItemID(HomeCategoryBuilder homeCategory1, HomeCategoryBuilder homeCategory2)
        {
        ...
        /// Compares 2 instances of HomeCategory.
        /// </summary>
        public static int CompareBySiteID(HomeCategoryBuilder homeCategory1, HomeCategoryBuilder homeCategory2)
        {
        ...
        /// Compares 2 instances of HomeCategory.
        /// </summary>
        public static int CompareByModuleID(HomeCategoryBuilder homeCategory1, HomeCategoryBuilder homeCategory2)
        {
        ...
        /// Compares 2 instances of HomeCategory.
        /// </summary>
        public static int CompareByTitle(HomeCategoryBuilder homeCategory1, HomeCategoryBuilder homeCategory2)
        {
        ...
        /// Compares 2 instances of HomeCategory.
        /// </summary>
        public static int CompareByItemUrl(HomeCategoryBuilder homeCategory1, HomeCategoryBuilder homeCategory2)
        {
        ...
        /// Compares 2 instances of HomeCategory.
        /// </summary>
        public static int CompareByDescription(HomeCategoryBuilder homeCategory1, HomeCategoryBuilder homeCategory2)
        {
        ...
        /// Compares 2 instances of HomeCategory.
        /// </summary>
        public static int CompareByDateCreate(HomeCategoryBuilder homeCategory1, HomeCategoryBuilder homeCategory2)
        {
        ...
        /// Compares 2 instances of HomeCategory.
        /// </summary>
        public static int CompareByOrderBy(HomeCategoryBuilder homeCategory1, HomeCategoryBuilder homeCategory2)
        {
        ...
        /// Compares 2 instances of HomeCategory.
        /// </summary>
        public static int CompareByItemIcon(HomeCategoryBuilder homeCategory1, HomeCategoryBuilder homeCategory2)
        {
