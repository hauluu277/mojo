...
namespace mojoPortal.Business
{
    ...
    public class Comment
    {
        ...
        private DateTime lastModUtc = DateTime.Now;
        private byte moderationStatus = 0; //default to approved but can be set by feature 
        ...
        private string articleItemUrl = string.Empty;
        private int articleID = 0;
        private int articleStep = 0;
        ...
        public int ArticleStep
        {
            get { return articleStep; }
            set { articleStep = value; }
        }
        ...
        public string ArticleItemUrl
        {
            get { return articleItemUrl; }
            set { articleItemUrl = value; }
        }
