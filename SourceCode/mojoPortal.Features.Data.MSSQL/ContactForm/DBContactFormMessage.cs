...
namespace mojoPortal.Data
{
    ...
    public static class DBContactFormMessage
    {
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_ContactFormMessage_Insert", 12);
            ...
            sph.DefineSqlParameter("@TrangThai", SqlDbType.Int, ParameterDirection.Input, trangThai);
            sph.DefineSqlParameter("@ThoiGianPhanHoi", SqlDbType.DateTime, ParameterDirection.Input, thoiGianPhanHoi);
        ...
        public static bool Update(
            ...
            DateTime? thoiGianPhanHoi)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_ContactFormMessage_Update", 12);
            sph.DefineSqlParameter("@RowGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, rowGuid);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
            sph.DefineSqlParameter("@Email", SqlDbType.NVarChar, 100, ParameterDirection.Input, email);
        ...
        /// </summary>
        public static int GetCount(string name, string email, Guid moduleGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_ContactFormMessage_GetCount", 3);
            sph.DefineSqlParameter("@FullName", SqlDbType.NVarChar,255, ParameterDirection.Input, name);
            ...
            out int totalPages)
        {
            totalPages = 1;
            int totalRows
                = GetCount(name, email, moduleGuid);
            ...
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_ContactFormMessage_SelectPageByModule", 5);
            sph.DefineSqlParameter("@FullName", SqlDbType.NVarChar, 255, ParameterDirection.Input, name);
            sph.DefineSqlParameter("@Email", SqlDbType.NVarChar, 255, ParameterDirection.Input, email);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
