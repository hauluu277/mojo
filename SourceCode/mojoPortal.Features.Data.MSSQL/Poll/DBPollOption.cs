...
namespace PollFeature.Data
{
    ...
    public static class DBPollOption
    {
        ...
        public static IDataReader GetPollOptionsBy(Guid pollGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_PollOptions_SelectBy", 1);
            sph.DefineSqlParameter("@PollGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, pollGuid);
            return sph.ExecuteReader();
        ...
        public static int Add(
            ...
            bool isPublish)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_PollOptions_Insert", 6);
            sph.DefineSqlParameter("@OptionGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, optionGuid);
            sph.DefineSqlParameter("@PollGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, pollGuid);
        ...
        public static bool Update(
            ...
            bool isPublish)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_PollOptions_Update", 5);
            sph.DefineSqlParameter("@OptionGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, optionGuid);
            sph.DefineSqlParameter("@Answer", SqlDbType.NVarChar, 255, ParameterDirection.Input, answer);
            sph.DefineSqlParameter("@Order", SqlDbType.Int, ParameterDirection.Input, order);
            sph.DefineSqlParameter("@IsApprove", SqlDbType.Bit, ParameterDirection.Input, isApprove);
        ...
        public static bool DeleteByPollGuid(Guid optionGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_PollOptions_DeleteByPollGuid", 1);
            sph.DefineSqlParameter("@PollGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, optionGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
