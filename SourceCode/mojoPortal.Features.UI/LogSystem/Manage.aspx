<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="Manage.aspx.cs" Inherits="LogSystemFeature.UI.Manage" %>

<%@ Register Src="~/LogSystem/Control/PostList.ascx" TagPrefix="portal" TagName="PostList" %>
