        ...
        <portal:mojoPanel ID="mp1" runat="server" ArtisteerCssClass="art-Post" RenderArtisteerBlockContentDivs="true">
            ...
            <asp:Panel ID="pnlWrapper" runat="server" CssClass="art-Post-inner panelwrapper managepost">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active fade in" id="tab_default_1">
                                        <div class="search">
                                            <div class="row20">
                                                <label>Năm</label>
                                                <asp:DropDownList ID="ddlYear" Width="150" CssClass="form-control" runat="server"></asp:DropDownList>
                                            </div>
                                            <div class="row20">
                                                <label>Tháng</label>
                                                <asp:DropDownList ID="ddlMonth" Width="150" mutiple CssClass="form-control" runat="server"></asp:DropDownList>
                                            </div>
                                            ...
                                            <div class="row20 pdt15">
                                                <label>&nbsp;</label>
                                                <span class="btn btn-primary" onclick="search_statistic_tab1(); return false;" style="border-radius: 0">Thống kê</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="tab_default_2">
                                        <div class="search">
                                            <div class="row25 col-sm-6 pd0">
                                                <label>Từ ngày</label>
                                                <input type="text" class="form-control date width200" name="date" id="startDate2" />
                                            ...
                                            <div class="row25 col-sm-6 pd0">
                                                ...
                                                <input type="text" class="form-control date width200" name="date" id="endDate2" />
                                                <%-- <span class="input-group-addon add-on addcontrol">
                                                         <i class="fa fa-calendar" aria-hidden="true"></i>
                                                     </span>--%>
                                            </div>
                                            ...
                                            <div class="row10">
                                                <label>&nbsp;</label>
                                                <span class="btn btn-primary" onclick="search_statisticTab2(); return false;" style="border-radius: 0">Thống kê</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="tab_default_3">
                                        <div class="search">
                                            <div class="row25 col-sm-6 pd0">
                                                <label>Từ ngày</label>
                                                <input type="text" class="form-control date width200" name="date" id="startDate3" />
                                                <%-- <span class="input-group-addon add-on addcontrol">
                                                             <i class="fa fa-calendar" aria-hidden="true"></i>
                                                     </span>--%>
                                            </div>
                                            <div class="row25 col-sm-6 pd0">
                                                <label>Đến ngày</label>
                                                <input type="text" class="form-control date width200" name="date" id="endDate3" />
                                                <%-- <span class="input-group-addon add-on addcontrol">
                                                         <i class="fa fa-calendar" aria-hidden="true"></i>
                                                     </span>--%>
                                            </div>
                                            ...
                                            <div class="row10 wf100">
                                                <label>&nbsp;</label>
                                                <span class="btn btn-primary" onclick="search_statisticTab3(); return false;" style="border-radius: 0">Thống kê</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="tab_default_4">
                                        <div class="search">
                                            <div class="row25 col-sm-6 pd0">
                                                <label>Từ ngày</label>
                                                <input type="text" class="form-control date width200" name="date" id="startDate4" />
                                                <%-- <span class="input-group-addon add-on addcontrol">
                                                             <i class="fa fa-calendar" aria-hidden="true"></i>
                                                     </span>--%>
                                            </div>
                                            <div class="row25 col-sm-6 pd0">
                                                <label>Đến ngày</label>
                                                <input type="text" class="form-control date width200" name="date" id="endDate4" />
                                                <%-- <span class="input-group-addon add-on addcontrol">
                                                         <i class="fa fa-calendar" aria-hidden="true"></i>
                                                     </span>--%>
                                            </div>
                                            ...
                                            <div class=" row20 pdt15">
                                                <label>&nbsp;</label>
                                                <span class="btn btn-primary" onclick="search_statisticTab4(); return false;" style="border-radius: 0">Thống kê</span>
                                            </div>
                                        </div>
                ...
                <script type="text/javascript">
                    ...
                    function search_statistic() {
                        var category = "";
                        var siteId = "";
                        siteId = $("#<%=lboxSiteTab_1.ClientID%>").val().toString();
                    ...
                    function get_statistic(obj_param) {
                        $.ajax({
                            type: "POST",
                            cache: false,
                            data: JSON.stringify(obj_param),
                            url: "/ArticleStatistic/ManageStatistic.aspx/ArticleTotalDatetime",
                            contentType: "application/json; charset= utf-8",
                            dataType: "json",
                            async: false,
                            success: success_
