...
{
    public partial class ManageStatistic : mojoBasePage
    {
        ...
        override protected void OnInit(EventArgs e)
        {
            ...
            lboxSiteTab_3.SelectedIndexChanged += LboxSiteTab_3_SelectedIndexChanged;
            base.OnInit(e);
            LoadSettings();
        }
        ...
        {
            var siteTab3 = lboxSiteTab_3.SelectedValue;
            var listAuthorBySite = SiteUser.GetUserBySite(siteTab3.ToIntOrZero());
            lboxAuthorTab_3.DataValueField = "UserID";
        ...
        private void BindCategory()
        {
            ...
            lboxSiteTab_1.DataValueField = "SiteID";
            lboxSiteTab_1.DataTextField = "SiteName";
            lboxSiteTab_1.DataSource = listSite;
            lboxSiteTab_1.DataBind();

            lboxSiteTab_2.DataValueField = "SiteID";
            lboxSiteTab_2.DataTextField = "SiteName";
            lboxSiteTab_2.DataSource = listSite;
            lboxSiteTab_2.DataBind();

            lboxSiteTab_3.DataValueField = "SiteID";
            lboxSiteTab_3.DataTextField = "SiteName";
            lboxSiteTab_3.DataSource = listSite;
            lboxSiteTab_3.DataBind();

            lboxSiteTab_4.DataValueField = "SiteID";
            lboxSiteTab_4.DataTextField = "SiteName";
            lboxSiteTab_4.DataSource = listSite;
            lboxSiteTab_4.DataBind();
            ...
            lboxAuthorTab_4.DataValueField = "UserId";
            lboxAuthorTab_4.DataTextField = "LoginName";
            lboxAuthorTab_4.DataSource = listAuthor;
            lboxAuthorTab_4.DataBind();
            ...
            lboxCategoryTab_4.DataValueField = "ItemID";
            lboxCategoryTab_4.DataTextField = "Name";
            lboxCategoryTab_4.DataSource = listCategory;
            lboxCategoryTab_4.DataBind();



            lboxSiteTab_1.SelectedValue = siteSettings.SiteId.ToString();
            lboxSiteTab_2.SelectedValue = siteSettings.SiteId.ToString();
            lboxSiteTab_3.SelectedValue = siteSettings.SiteId.ToString();
            lboxSiteTab_4.SelectedValue = siteSettings.SiteId.ToString();
        ...
        private void BindMonthAndYear()
        {
            ...
            ddlYear.DataBind();
            ddlYear.SelectedValue = yearCurrent.ToString();
            ...
            ddlMonth.DataBind();
            ddlMonth.SelectedValue = monthCurrent.ToString();
        ...
        private void PopulateLabels()
        {
            ...
            heading.Text = "Thống kê tin bài";
            lnkCurrentPage.NavigateUrl = SiteRoot + "/ArticleStatistic/ManageStatistic.aspx";
            lnkCurrentPage.Text = "Thống kê tin bài";
