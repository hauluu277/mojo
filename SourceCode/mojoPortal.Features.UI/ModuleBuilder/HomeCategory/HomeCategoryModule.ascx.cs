...
{
    public partial class HomeCategoryModule : SiteModuleControl
    {
        ...
        {
            rptCategory.DataSource = HomeCategory.GetAll().Where(x => x.ModuleID == ModuleId).OrderBy(x => x.OrderBy).Take(4).ToList();
