...
{
    public partial class LinkSelectorOrderBySetting : UserControl, ISettingControl
    {
        ...
        private void BindDDLModules()
        {
            ...
            var status = SiteUtils.StringToDictionary(AdminLinkResources.LinkCategoryOrderBySetting.ToString(), ",");
