...
<script>
    $(document).ready(function () {
        $(".HienThiDangRutGon .qa-question-item").on("click", function (e) {
            e.preventDefault();
            $(this).find(".qa-question-title a").toggleClass("collapsed");
            $(this).find(".qa-question-meta").toggleClass("show");
            $(this).find(".qa-question-stats").toggleClass("show");
            $(this).find(".qa-question-content").toggleClass("show");
        })
    })
</script>
