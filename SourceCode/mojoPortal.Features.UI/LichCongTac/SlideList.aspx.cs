...
namespace mojoPortal.Features.UI.LichCongTac
{
    public partial class SlideList : System.Web.UI.Page
    {
        ...
        {
            RecentSlideList.ModuleId = moduleId;
            RecentSlideList.PageId = pageId;
            RecentSlideList.Config = config;
            //RecentSlideList.SiteRoot = SiteRoot;
            //RecentSlideList.ImageSiteRoot = ImageSiteRoot;
        }
