...
{
    public partial class RecentSlideList : UserControl
    {
        #region Properties
        ...
        {
            //lnkPre.NavigateUrl = siteSetting.SiteRoot + "/lichcongtac/ViewList.aspx?pageid=" + pageId + "&mid=" + moduleId + "&week=" + currentWeek + "&year=" + currentYear + "&lnk=" + 0;
            //lnkNext.NavigateUrl = siteSetting.SiteRoot + "/lichcongtac/ViewList.aspx?pageid=" + pageId + "&mid=" + moduleId + "&week=" + currentWeek + "&year=" + currentYear + "&lnk=" + 1;
        }
        ...
        private void PopulateControls()
        {
            ...
            lblbedate.Text = "từ ngày " + weekmapdate.StartDate.ToString("dd/MM/yyyy") + " đến ngày " + weekmapdate.EndDate.ToString("dd/MM/yyyy");
            lblweek.Text = "Tuần thứ " + currentWeek + " - ";
            // + currentWeek + " - Năm " + currentYear
            PoupulateBindDay();
            //BindDocument();
        }
