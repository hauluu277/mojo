...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
                    ...
                    <div id="divtabs" class="mojo-tabs">
                        ...
                        <div id="tabContent">
                            ...
                            <div class="settingrow">
                                ...
                                <asp:TextBox ID="txtTitle" runat="server" TextMode="MultiLine" Rows="3" MaxLength="255" Width="100%" CssClass="forminput verywidetextbox">
                                </asp:TextBox>
    ...
    <script type="text/javascript">
       ...
       <%--                     $("#<%=nuImageUrl.ClientID%>").val("");
                            ...
                            if (parseFloat(files[0].size / 1024).toFixed(2) > 1024) {
