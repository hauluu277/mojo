...
{
    public partial class ManageArticleCTVControl : UserControl
    {
        #region Properties
        ...
        private void BindArticles()
        {
            ...
            DeleteLinkImageUrl = "/Data/SiteImages/huy.png";
            ...
            reader = Article.GetAllArticleCTVPage(siteSettings.SiteId, pageNumber, config.PageSize, categoryID, isApprove, isPublish, _isHot, _isHome, _startDate, _endDate, ArticleCategory, keyword_search, authorID, createDateArticle, out totalPages, out totalRow);

            rptArticles.DataSource = reader;
            rptArticles.DataBind();
            lblTotalArticle.Text = string.Format("Tổng số {0} tin bài", totalRow);
            string pageUrl = SiteRoot + "/article/managearticleCTV.aspx"
        ...
        protected void rptArticles_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if (itemType == ListItemType.Item || itemType == ListItemType.AlternatingItem)
            {
                ...
                else if (e.CommandName.Equals("DeleteItem"))
                {
                    ...
                    WebUtils.SetupRedirect(this, SiteRoot + "/article/managearticlectv.aspx?pageid="
        ...
        protected void rptArticles_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (itemType == ListItemType.Item || itemType == ListItemType.AlternatingItem)
            {
                ...
                SiteUtils.AddConfirmButton(ibtnDelete, "Xác nhận hủy bỏ tin bài");
            }
        }
