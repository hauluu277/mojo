                    ...
                    <asp:Panel runat="server" ID="pnlContentArticle">
                        ...
                        <div class="width100pad">
                            ...
                            <div class="contentdes-right social-right">
                                <span id="pnlWCAG" runat="server" class="wvag">&nbsp; &nbsp;Xem với cỡ chữ 
                            ...
                            <div class="search-orther">
                                <div class=" collapse" id="search-article">
                                    <div class="form-group col-sm-6" style="padding-top: 10px;">
                                        <label for="filter"><i class="fa fa-star" aria-hidden="true"></i>&nbsp;Danh mục</label>
                                        <asp:DropDownList ID="ddlCategorySearch" Style="width: 100%" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                    <div class="form-group col-sm-6" style="padding-top: 10px;">
                                        <label for="contain"><i class="fa fa-calendar" aria-hidden="true"></i>&nbsp;Ngày đăng tin</label>
                                    ...
                                    <div class="form-group col-sm-12">
                                        <label for="contain" style="width: 100%"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Từ khóa</label>
                                        <input class="form-control" style="width: 100%" type="text" id="keyword" />
                                    </div>
                                    <div class="form-group col-sm-12" style="text-align: center">
                                        <button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#search-article"><span>X</span> Đóng</button>
                                        <button type="button" class="btn btn-primary" onclick="SearchArticle(1)"><i class="fa fa-search" aria-hidden="true"></i>Tìm kiếm</button>
                                    </div>
                                </div>
