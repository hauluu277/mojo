...
{
    public partial class ArticleSelectorThemeSetting : UserControl, ISettingControl
    {
        ...
        private void BindDDLModules()
        {
            ...
            listTab.Add(new ListItem { Text = "Hiển thị text box rút gọn", Value = ArticleTabListTypeConstant.ShowSort.ToString() });
            listTab.Add(new ListItem { Text = "Hiển thị text box đầy đủ", Value = ArticleTabListTypeConstant.ShowFull.ToString() });
