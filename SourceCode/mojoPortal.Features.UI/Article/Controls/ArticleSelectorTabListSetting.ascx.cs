...
{
    public partial class ArticleSelectorTabListSetting : UserControl, ISettingControl
    {
        ...
        private void BindDDLModules()
        {
            ...
            listTab.Add(new ListItem { Text = "Hiển thị hình ảnh", Value = ArticleTabListTypeConstant.ShowImage.ToString() });
            listTab.Add(new ListItem { Text = "Ẩn hình ảnh", Value = ArticleTabListTypeConstant.HideImage.ToString() });
