...
{
    public partial class ManageArticleCTV : mojoBasePage
    {
        ...
        {
            ManageArticleCTVControl.ModuleId = moduleId;
            ManageArticleCTVControl.PageId = pageId;
            ManageArticleCTVControl.Config = config;
            ManageArticleCTVControl.SiteRoot = SiteRoot;
            ManageArticleCTVControl.ImageSiteRoot = ImageSiteRoot;
        }
        private void PopulateLabels()
        {
            ...
            //}
            heading.Text = "Quản lý danh sách tin bài cổng thành viên";
        ...
        private void LoadParams()
        {
            ...
            if (pageId <= 0)
            {
                ...
                lnkCurrentPage.NavigateUrl = SiteRoot + "/Article/ManageArticleCTV.aspx";
                lnkCurrentPage.Text = "Danh sách tin bài cổng thành viên";
