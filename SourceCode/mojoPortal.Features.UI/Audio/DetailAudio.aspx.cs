...
{
    public partial class DetailAudio : mojoBasePage
    {
        ...
        {
            audioDetailControl.ModuleId = moduleId;
            audioDetailControl.PageId = pageId;
            audioDetailControl.SiteRoot = SiteRoot;
            audioDetailControl.ImageSiteRoot = ImageSiteRoot;
            audioDetailControl.GroupMediaID = groupMediaId;
            //Title = SiteUtils.FormatPageTitle(siteSettings, Resources.MediaResources.MultiMediaDataTitle);
        ...
        {
            Title = SiteUtils.FormatPageTitle(siteSettings, "Audio");
