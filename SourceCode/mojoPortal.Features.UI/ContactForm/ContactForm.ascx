...
<fieldset>
    <asp:Panel ID="pnlSend" runat="server" SkinID="plain" DefaultButton="btnSend">
        ...
        <asp:Label ID="lblTitle" runat="server" CssClass="contact-title"></asp:Label>
		<div class="settingrow">
		    <mp:SiteLabel id="lblEmail" runat="server" ForControl="txtEmail" ConfigKey="ContactFormYourEmailTitle" ResourceFile="ContactFormResources" CssClass="settinglabel"></mp:SiteLabel>
