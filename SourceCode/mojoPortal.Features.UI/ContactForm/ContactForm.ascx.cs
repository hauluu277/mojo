...
namespace mojoPortal.Web.ContactUI
{
    ...
    public partial class ContactForm : SiteModuleControl
    {
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            ...
            if (isValid && (edMessage.Text.Length > 0))
            {
                ...
                if (config.KeepMessages && (m.ModuleGuid != Guid.Empty))
                {
                    ...
                    contact.Message = edMessage.Text;
                ...
                lblMessage.Text = "Cảm ơn, nội dung liên hệ của bạn đã được gửi!";
            ...
            btnSend.Text = ContactFormResources.ButtonSendTitle;
        ...
        private void PopulateLabels()
        {
            ...
            Page.ClientScript.GetPostBackEventReference(btnSend, string.Empty)
            );

            ArticleUtils.AddConfirmButton(btnSend, "Bạn có chắc chắn muốn gửi liên hệ?");
            ...
            if (ModuleConfiguration != null)
            {
                ...
                lblTitle.Text = ModuleConfiguration.ModuleTitle;
            ...
            //                "' class='ModuleEditLink cblink' title='Xem liên hệ'>Xem liên hệ</a>"
            //            ;
            //        }
            //    }
            //}
        ...
        private void LoadSettings()
        {
            ...
            pnlOuterBody.CssClass = config.TypeThemeSetting;
