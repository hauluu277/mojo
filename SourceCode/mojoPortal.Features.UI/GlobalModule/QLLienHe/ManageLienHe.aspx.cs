...
namespace QLLienHeFeatures.UI
{
    public partial class ManageLienHe : mojoBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!WebUser.IsInRoles(WebConfigSettings.RoleManageLienHe))
            {
        ...
        {
            Title = SiteUtils.FormatPageTitle(siteSettings, "Quản lý Liên hệ");
        }
