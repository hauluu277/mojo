<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master" CodeBehind="Manage.aspx.cs" Inherits="BieuMauThongTinFeatures.UI.Manage" %>
...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            CallAjaxLoading("get", "/BieuMauThongTinArea/BieuMauThongTin/Index", null, true, function (rs) {
