<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master" CodeBehind="Detail.aspx.cs" Inherits="BieuMauThongTinFeatures.UI.Detail" %>
...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            CallAjaxLoading("get", "/BieuMauThongTinArea/BieuMauThongTin/DetailNopBieuMau?idNopBieuMau=" + id, null, true, function (rs) {
