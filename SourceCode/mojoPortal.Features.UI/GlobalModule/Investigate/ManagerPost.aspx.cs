...
namespace InvestigateFeatures.UI
{
    public partial class ManagerPost : mojoBasePage
    {
        ...
        {
            Title = SiteUtils.FormatPageTitle(siteSettings, "Danh sách cuộc điều tra");
            BreadCrumbControl.InfoLink_1 = new mojoPortal.Business.WebHelpers.CommonModel.InfoLink();
            BreadCrumbControl.InfoLink_1.NameLink = "Danh sách cuộc điều tra";
            BreadCrumbControl.InfoLink_1.UrlLink = "/GlobalModule/Investigate/ManagerPost.aspx";
