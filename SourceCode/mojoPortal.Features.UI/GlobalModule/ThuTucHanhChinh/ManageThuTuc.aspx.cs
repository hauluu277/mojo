...
namespace ThuTucFeatures.UI
{
    public partial class ManageThuTuc : mojoBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!WebUser.IsInRoles(WebConfigSettings.RoleManageThuTucHanhChinh))
            {
        ...
        {
            Title = SiteUtils.FormatPageTitle(siteSettings, "Quản lý thủ tục hành chính");
        }
