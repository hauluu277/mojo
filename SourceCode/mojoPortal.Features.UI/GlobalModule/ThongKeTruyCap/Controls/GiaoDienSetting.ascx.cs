...
using static mojoPortal.Features.UI.GlobalModule.ThongKeTruyCap.GiaoDienConstant;

namespace ThongKeTruyCapFeature.UI
{
    public partial class GiaoDienSetting : UserControl, ISettingControl
    {
        ...
        private void BindDDLModules()
        {
            ...
            listTab.Add(new ListItem { Text = "Chọn Giao Diện", Value = "" });
            listTab.Add(new ListItem { Text = "Giao diện bảng", Value = GiaoDien.GiaoDien1.ToString() });
            listTab.Add(new ListItem { Text = "Giao diện chi tiết", Value = GiaoDien.GiaoDien2.ToString() });
