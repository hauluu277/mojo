                                                    ...
                                                    <div class="tong-dieu-tra class-pd">
                                                        <a href="<%#string.Format("{0}{1}",SiteRoot,Eval("Description")) %>">
                                                            <div class="bg-color-tongdieutra">
                                                                ...
                                                                <div class="tongdieutra-text"><a href="<%#string.Format("{0}{1}",SiteRoot,Eval("Description")) %>"><%#Eval("Name") %></a></div>
                                                            </div>
                                                        </a>
                                                    </div>
                                                </ItemTemplate>
                                        ...
                                        <ItemTemplate>
                                            <div class="linhvuc-col">
                                                ...
                                                <div class="linhvuc-col-right">
                                                    <a href="<%#string.Format("{0}{1}",SiteRoot,Eval("Description")) %>"><%#Eval("Name") %></a>
                                                </div>
                                            </div>
                                        </ItemTemplate>
                                    </asp:Repeater>
