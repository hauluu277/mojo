...
namespace DanhSachTruongFeature.UI
{
    ...
    public partial class DanhSachTruongModule : SiteModuleControl
    {
        ...
        private void PopulateControls()
        {
            ...
            DanhSachTruongList.ModuleId = ModuleId;
            DanhSachTruongList.PageId = PageId;
            DanhSachTruongList.SiteRoot = SiteRoot;
            DanhSachTruongList.IsEditable = IsEditable;
        }
