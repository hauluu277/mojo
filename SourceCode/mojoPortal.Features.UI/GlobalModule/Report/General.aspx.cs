...
{
    public partial class General : mojoBasePage
    {
        ...
        {
            Title = SiteUtils.FormatPageTitle(siteSettings, "Tổng hợp báo cáo thống kê cuộc điều tra");
            BreadCrumbControl.InfoLink_1 = new mojoPortal.Business.WebHelpers.CommonModel.InfoLink();
            BreadCrumbControl.InfoLink_1.NameLink = "Tổng hợp báo cáo thống kê các cuộc điều tra";
            BreadCrumbControl.InfoLink_1.UrlLink = "/GlobalModule/Report/General.aspx";
