...
namespace WebserviceFeatures.UI
{
    public partial class ManagerPost : mojoBasePage
    {
        ...
        {
            Title = SiteUtils.FormatPageTitle(siteSettings, "Cấu hình webservice cuộc điều tra");
            BreadCrumbControl.InfoLink_1 = new mojoPortal.Business.WebHelpers.CommonModel.InfoLink();
            BreadCrumbControl.InfoLink_1.NameLink = "Cấu hình webservice cuộc điều tra";
            BreadCrumbControl.InfoLink_1.UrlLink = "/GlobalModule/Webservice/ManagerPost.aspx";
