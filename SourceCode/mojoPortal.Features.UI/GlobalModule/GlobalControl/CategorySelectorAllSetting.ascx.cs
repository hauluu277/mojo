...
namespace Global.UI
{
    public partial class CategorySelectorAllSetting : UserControl, ISettingControl
    {
        ...
        private void BindArticleCategorys()
        {
            ...
            listCate.Insert(0, new ListItem(ArticleResources.ParentCategoryChoose, ""));
            ddlCategory.DataSource = listCate;
                ...
                if (!selectedValue.Equals(string.Empty))
                {
                    ...
                    if (list_category_config != null)
                    {
                        ...
                        foreach (var cat in list_category_config)
                        {
                            ...
                            {
                                listItem = ddlCategory.Items.FindByValue(cat);
                                if (listItem != null)
                                {
            ...
            {
                ddlCategory.Items[i].Text = ddlCategory.Items[i].Text.Replace("<span class='second left'>", string.Empty).Replace(
