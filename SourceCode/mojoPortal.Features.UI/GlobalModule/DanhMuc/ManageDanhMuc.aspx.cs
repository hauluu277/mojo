...
namespace DanhMucFeatures.UI
{
    public partial class ManageDanhMuc : mojoBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!WebUser.IsInRoles(WebConfigSettings.RoleManageGiaoDien))
            {
        ...
        {
            Title = SiteUtils.FormatPageTitle(siteSettings, "Quản lý chuyên mục liên kết");
        }
