...
namespace QLLogFeatures.UI
{
    public partial class ManageLog : mojoBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!WebUser.IsInRoles(WebConfigSettings.RoleManageNhatKy))
            {
        ...
        {
            Title = SiteUtils.FormatPageTitle(siteSettings, "Quản lý Log");
        }
