...
{
    public partial class VideoSelectItemSetting : UserControl, ISettingControl
    {
        ...
        private void BindDDLModules()
        {
            ...
            var source = VideoIntroduce.GetAllPublic(siteSetting.SiteId);
            lboxGallery.DataSource = source;
            lboxGallery.DataTextField = "Title";
