...
{
    public partial class VideoIntroduceModule : SiteModuleControl
    {
        ...
        private void PopulateControls()
        {
            ...
            VideoIntroduceRecenlist.SiteId = SiteId;
            VideoIntroduceRecenlist.Config = config;
            VideoIntroduceRecenlist.SiteRoot = SiteRoot;
            VideoIntroduceRecenlist.IsEditable = IsEditable;
            VideoIntroduceRecenlist.siteSettings = siteSettings;
