...
<div style="margin-bottom: 0px;">
            ...
            <div class="why__choose__us">
                ...
                <asp:Repeater ID="rptActicleTab10" runat="server">
                    <ItemTemplate>
                     ...
                     <div class="box-2 sv_tn_content-center wow bounceInDown " style="visibility: visible; animation-delay: 0.4s;"><img alt="" class="cangiua" src="../Data/Sites/120/skins/framework/images/why_tuyen_sinh.png" /></div>
                <asp:Repeater ID="rptActicleTab10_2" runat="server">
                    <ItemTemplate>
                        <div class="sv_tn_content-right-1 wow fadeInRight" style="visibility: visible; animation-delay: 0.5s;">
                            <div class="sv_tn_content-left-1">
                                <h3>
                                     <a title="<%#Eval("Title") %>" class="ahover" href="<%# ArticleUtils.FormatBlogTitleUrl(SiteRoot, Eval("ItemUrl").ToString(), Convert.ToInt32(Eval("ItemID")), PageId, ModuleId) %>">
                                            <%#Eval("Title") %>
                                ...
                                <ItemTemplate>
                                    <div class="han-dt-content wow fadeInLeft" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s;">
                                        <div class="han-dt--img"> <img src="<%# ArticleUtils.FormatImageDialog(ConfigurationManager.AppSettings["ArticleImagesFolder"], Eval("ImageUrl").ToString()) %>" title="<%#Eval("Title") %>" />
                                            <div class="han-dt--hover"><a class="fa fa-check-square-o" href="<%# ArticleUtils.FormatBlogTitleUrl(SiteRoot, Eval("ItemUrl").ToString(), Convert.ToInt32(Eval("ItemID")), PageId, ModuleId) %>" tabindex="0"><span>a</span></a></div>
                                            </div>
    ...
    <asp:Panel ID="pnlUseTab8" runat="server">
        <div class="taisao_chonchung_toi_haan">
            ...
            <div class="intro-left">
                <asp:HyperLink ID="hplcategorytab8" CssClass="page-header" runat="server"></asp:HyperLink>
                </div>
    ...
    <asp:Panel ID="pnlUseTab7" runat="server">
        <div class="sinhvien_totnghiep_haan">
            <asp:HyperLink ID="hplcategorytab7" CssClass="page-header" runat="server"></asp:HyperLink>
            <div class="container">
            <div class="col-sm-6 pdl0"><img alt="Sinh viên sau khi tốt nghiệp ĐHSPTN" src="/Data/Sites/1/media/admin/images/totnghiep.png" /></div>
                ...
                <asp:Repeater ID="rptTab_5" runat="server">
                    <ItemTemplate>
                        <div class="tin-hoat-dong-item">
                            ...
                            <div class="tin-hot-dong-summary">
                                <%#Eval("Summary") %>
                            </div>
                        </div>
                    </ItemTemplate>
