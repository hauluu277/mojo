        ...
        <div class="bottom-spacing">
            <div class="search-item">
                ...
                <div class="search-control">
                    <asp:DropDownList Width="100%" ID="ddlLinhVuc" runat="server"></asp:DropDownList>
                </div>
            </div>
            <div class="search-item">
                ...
                <div class="search-control">
                    <asp:DropDownList Width="100%" ID="ddlLoaiVB" runat="server"></asp:DropDownList>
                </div>
            </div>
            <div class="search-item">
                ...
                <div class="search-control">
                    <asp:DropDownList Width="100%" ID="ddlStatus" runat="server"></asp:DropDownList>
                </div>
            </div>
            <div class="search-item">
                ...
                <table class="tablesorter" id="myTable">
                    <tr>
                        ...
                        <th style="width: 35%" class="tbl-header">
                            <%#Resources.DocumentResources.SummaryLabel %>
                        </th>
                        <th style="width: 10%" class="tbl-header">
                            <%#Resources.DocumentResources.LinhVucLabel %>
                        </th>
                        <th style="width: 10%" class="tbl-header">
                            <%#Resources.DocumentResources.LoaiVBLabel %>
                        </th>
                        <%if(isAdmin){ %>
