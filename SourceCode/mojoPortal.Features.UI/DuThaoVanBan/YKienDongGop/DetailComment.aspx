...
<mp:SiteLabel id="lblName" runat="server" ForControl="litName" CssClass="settinglabel" ConfigKey="NameLabel" ResourceFile="DuThaoVanBanResources" />
    <asp:Literal ID="litName" runat="server" EnableViewState="false"></asp:Literal>
</div>
<div class="settingrow">
<mp:SiteLabel id="SiteLabel1" runat="server" ForControl="litEmail" CssClass="settinglabel" ConfigKey="EmailLabel" ResourceFile="DuThaoVanBanResources" />
...
<div class="settingrow">
<mp:SiteLabel id="SiteLabel4" runat="server" ForControl="litContent" CssClass="settinglabel" ConfigKey="CommentLabel" ResourceFile="DuThaoVanBanResources" />
