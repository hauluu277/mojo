            ...
            <HeaderTemplate>
                <table class="tablesorter" id="myTable">
                    <tr>
                        ...
                        <th style="width: 15%" class="tbl-header"><%#Resources.DuThaoVanBanResources.NameLabel %></th>
                        <th style="width: 10%" class="tbl-header">
                            <%#Resources.DuThaoVanBanResources.EmailLabel %>
                        </th>
                        ...
                        <th style="width: 29%" class="tbl-header">
                            <%#Resources.DuThaoVanBanResources.CommentLabel %>
                        </th>
