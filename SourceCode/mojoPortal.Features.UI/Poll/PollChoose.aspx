        ...
        <portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
            ...
            <portal:mojoDataList ID="dlPolls" runat="server" DataKeyField="PollGuid">
                <ItemTemplate>
                    ...
                    <br />
                    <asp:Button CommandName="Choose" runat="server" CssClass="buttonlink" ID="btnChoose" Visible='<%# CheckActivated(Convert.ToBoolean(Eval("IsApprove")),Convert.ToBoolean(Eval("IsPublish")),Convert.ToBoolean(Eval("Active")), Convert.ToDateTime(Eval("ActiveTo"))) %>'
                        Text='<%#GetStartActive(Eval("PollGuid").ToString()) %>' CommandArgument='<%# Eval("PollGuid") %>' />
                    ...
                    &nbsp;
                    <asp:Label ID="lblError" runat="server" ForeColor="Red" Text='<%# pollActivedError(Convert.ToBoolean(Eval("IsApprove")),Convert.ToBoolean(Eval("IsPublish"))) %>' Visible='<%# checkPollActiveedError(Convert.ToBoolean(Eval("IsApprove")),Convert.ToBoolean(Eval("IsPublish")))%>'></asp:Label>
                    <hr />
                </ItemTemplate>
            </portal:mojoDataList>
