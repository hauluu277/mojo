...
{
    public partial class ViewListControl : UserControl
    {
        #region Properties
        ...
        {
            reader = Article.GetPageByCategory(pageNumber, config.PageSize, categoryID.ToString(), out totalPages);
            ...
            var getCategory = new CoreCategory(categoryID);
            if (getCategory != null && getCategory.ItemID > 0 && getCategory.ShowMenuLeft)
            {
            ...
            string pageUrl = SiteRoot + "/ArticleTraining/ViewList.aspx"
