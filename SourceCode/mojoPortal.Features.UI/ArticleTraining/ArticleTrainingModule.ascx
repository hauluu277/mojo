<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ArticleTrainingModule.ascx.cs" Inherits="ArticleFeature.UI.ArticleTrainingModule" %>
<%@ Register Src="~/ArticleTraining/Controls/ArticleTrainingControl.ascx" TagPrefix="portal" TagName="ArticleTrainingControl" %>
            ...
            <asp:Panel ID="pnlWrapper" runat="server" CssClass="art-Post-inner panelwrapper blogmodule">
                ...
                <portal:mojoPanel ID="MojoPanel1" runat="server" ArtisteerCssClass="" RenderArtisteer="true" UseLowerCaseArtisteerClasses="true">
                    <div class="modulecontent">
                        <portal:ArticleTrainingControl runat="server" ID="ArticleTrainingControl" />
                    </div>
                </portal:mojoPanel>
                <div class="cleared">
                </div>
