...
{
    public partial class ArticleTrainingSiteModule : SiteModuleControl
    {
        ...
        {
            ArticleTrainingSiteControl.SiteId = SiteId;
            ArticleTrainingSiteControl.SiteRoot = SiteRoot;
            ArticleTrainingSiteControl.ModuleId = ModuleId;
            ArticleTrainingSiteControl.PageId = PageId;
        }
