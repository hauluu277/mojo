...
{
    public partial class ViewListMediaAlbum : mojoBasePage
    {
        ...
        {
            SlideAlbumList.ModuleId = moduleId;
            SlideAlbumList.PageId = pageId;
            SlideAlbumList.SiteRoot = SiteRoot;
            SlideAlbumList.ImageSiteRoot = ImageSiteRoot;
            SlideAlbumList.GroupMediaID = groupMediaId;
            //Title = SiteUtils.FormatPageTitle(siteSettings, Resources.MediaResources.MultiMediaDataTitle);

            if (config.ShowLink)
            {
                MediaGroup media = new MediaGroup(groupMediaId);
