...
{
    public partial class GallerySelectorTabSetting : UserControl, ISettingControl
    {
        ...
        private void BindDDLModules()
        {
            ...
            listTab.Add(new ListItem { Text = "Hiển thị lightbox", Value = MediaConstant.Lightbox.ToString() });
            listTab.Add(new ListItem { Text = "Hiển thị slider", Value = MediaConstant.Slider.ToString() });
