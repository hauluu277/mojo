<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="CategoriesList.ascx.cs" Inherits="MediaFeature.UI.CategoriesList" %>
...
<style>
    ...
    #ctl00_mainContent_CategoriesList_btnAddNewMediaGroup {
        float: right;
    }
</style>
<div class="width100">
    <fieldset class="fieldset">
        <legend class="legend">Tìm kiếm phóng sự ảnh</legend>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td id="haan_thuvienanh_row" style="vertical-align: top">
                    ...
                    <p class="haan_ngng haan_ngng_chuyenmuc"><span>Chuyên mục: </span><%# Eval("CategoryName") %></p>

                </td>
                <td style="vertical-align: top">
                    <img src="/Data/File/Media/<%#Eval("FilePath") %>" width="100" height="100" />
                </td>
                <td style="text-align: center; font-weight: bold"><%#MediaCommon.GetStatusText(Convert.ToInt32(Eval("Step")))  %></td>
