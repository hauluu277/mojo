...
{
    public partial class ManagePostCategories : mojoBasePage
    {
        ...
        {
            CategoriesList.PageId = pageId;
            CategoriesList.ModuleId = moduleId;
            CategoriesList.SiteRoot = SiteRoot;
        ...
        private void PopulateLabels()
        {
            ...
            TitleControl.EditText = "Quản lý thư viện ảnh";
            TitleControl.ModuleInstance = GetModule(moduleId);
            heading.Text = "Quản lý thư viện ảnh";
        }
