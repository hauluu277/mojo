...
{
    public partial class ArticleCategoryModule : SiteModuleControl
    {
        ...
        {
            ArticleCategoryControl.SiteId = SiteId;
            ArticleCategoryControl.SiteRoot = SiteRoot;
            ArticleCategoryControl.ModuleId = ModuleId;
            ArticleCategoryControl.PageId = PageId;
        }
