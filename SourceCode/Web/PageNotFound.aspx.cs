...
namespace mojoPortal.Web
{
    ...
    public partial class PageNotFoundPage : mojoBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                litErrorMessage.Text = "Chức năng này cổng đang phát triển, bạn vui lòng quay lại sau.";
                // chúng tôi không thể tìm thấy trang bạn đang tìm kiếm. Vui lòng liên hệ người quản trị để biết thêm thông tin.
            }
