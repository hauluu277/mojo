<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ArticleTrainingSiteModule.ascx.cs" Inherits="ArticleFeature.UI.ArticleTrainingSiteModule" %>
<%@ Register Src="~/ArticleTraining/Controls/ArticleTrainingSiteControl.ascx" TagPrefix="portal" TagName="ArticleTrainingSiteControl" %>
            ...
            <asp:Panel ID="pnlWrapper" runat="server" CssClass="art-Post-inner panelwrapper blogmodule">
                ...
                <portal:mojoPanel ID="MojoPanel1" runat="server" ArtisteerCssClass="" RenderArtisteer="true" UseLowerCaseArtisteerClasses="true">
                    <div class="modulecontent">
                        <portal:ArticleTrainingSiteControl runat="server" id="ArticleTrainingSiteControl" />
                    </div>
                </portal:mojoPanel>
                <div class="cleared">
                </div>
