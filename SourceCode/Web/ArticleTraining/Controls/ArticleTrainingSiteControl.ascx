<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ArticleTrainingSiteControl.ascx.cs" Inherits="ArticleFeature.UI.ArticleTrainingSiteControl" %>
        ...
        <table class="table table-bordered">
            <tbody>
                ...
                <asp:Repeater ID="rptCategory" runat="server">
                    <ItemTemplate>
                        <asp:Literal ID="liter" runat="server" Text='<%#GenRow(Eval("Name"),Eval("Description"), Eval("ItemID"))%>'></asp:Literal>
