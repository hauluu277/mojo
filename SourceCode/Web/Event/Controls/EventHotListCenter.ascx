                ...
                <div class="box_eventhot doc_slide">
                    ...
                    <div class="header_slide">
                        <h2 class="page-header">
                            <a href="/cac-khoa-boi-duong" title="Khóa đào tạo - bồi dưỡng">KHÓA ĐÀO TẠO - BỒI DƯỠNG</a>
                        </h2>
                    </div>
                    <div class="scroll-event">
                        <div id="event_hot" class="pd0">
                            <asp:Repeater ID="rptEventHot" runat="server">
                                <ItemTemplate>
                                   <div class="col-sm-4 event_hot__item event_hot__common">
                                   ...
                                   <div class="event_hot__item__clone__content">
                                        <asp:HyperLink ID="lnkDetail" runat="server" NavigateUrl='<%# FormatBlogTitleUrl(SiteRoot, Eval("ItemUrl").ToString(), Convert.ToInt32(Eval("ItemID")), PageId, ModuleId) %>'>
                                            ...
                                            <ul>
                                                <li>Thời lượng: <span></span></li>
                                                <li><span>Địa điểm: </span><span><%#Eval("Location") %></span></li>
                                                <li><span>Hạn đăng kí: </span>
