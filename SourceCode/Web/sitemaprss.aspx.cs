...
{
    public partial class sitemaprss : System.Web.UI.Page
    {
        ...
        public string createXML()
        {
            ...
            var listData = baoCaoBusiness.context.md_BaoCao.Where(x => x.IsPublish == true).OrderByDescending(x => x.NgayCongBo).ToList();
