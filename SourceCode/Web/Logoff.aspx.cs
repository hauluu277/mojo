...
namespace mojoPortal.Web.UI.Pages
{
    ...
    public partial class Logoff : Page
    {
        ...
        private void DoLogout()
        {
            ...
            if (ConfigurationManager.AppSettings["RedirectLogOff"].ToBoolOrFalse())
            {
                var redirectLogOffDieuHanh = ConfigurationManager.AppSettings["RedirectDieuHanh"] + ConfigurationManager.AppSettings["RedirectLogoffDieuHanh"];
                WebUtils.SetupRedirect(this, redirectLogOffDieuHanh);
            }
            else
            {
