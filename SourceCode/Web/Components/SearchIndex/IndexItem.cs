...
namespace mojoPortal.SearchIndex
{
    ...
    public class IndexItem : IComparable
    {
        ...
        public IndexItem(Lucene.Net.Documents.Document doc, float score)
        {
            ...
            ArticleFTS = luceneDoc.Get("ArticleFTS");
        ...
        private string articleFTS = string.Empty;
        ...
        [XmlIgnore]
        public string ArticleFTS
        {
            get { return articleFTS; }
            set
            {
                articleFTS = value;
            }
        ...
        [XmlElement(ElementName = "articleFTS", DataType = "base64Binary")]
        public byte[] ArticleFTSSerialization
        {
            get
            {
                return System.Text.Encoding.Unicode.GetBytes(ArticleFTS);
            }
            set
            {
                ArticleFTS = System.Text.Encoding.Unicode.GetString(value);
            }
        }
