...
namespace mojoPortal.Web
{
    ...
    public class mojoBasePage : Page
    {
        ...
        private ContentPlaceHolder topPane;
        private ContentPlaceHolder bottomPane;
        ...
        public ContentPlaceHolder MPTopPane
        {
            get { return topPane; }
            set { topPane = value; }
        }

        public ContentPlaceHolder MPBottomPane
        {
            get { return bottomPane; }
            set { bottomPane = value; }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            var redirectLogOff = ConfigurationManager.AppSettings["RedirectLogOff"].ToBooleanOrFalse();
            if(Request.IsAuthenticated && redirectLogOff)
            {
        ...
        override protected void OnPreInit(EventArgs e)
        {
            ...
            {
                loginName = HttpContext.Current.Request.Cookies["UserName"].Value;
            }
            //var loginName= CookieHelper.GetCookieValue("sso2021");
        ...
        private void SetupMasterPage()
        {
            ...
            if (!string.IsNullOrEmpty(MasterPageFile))
            {
                ...
                topPane = (ContentPlaceHolder)Master.FindControl("topContent");
                bottomPane = (ContentPlaceHolder)Master.FindControl("bottomContent");
            }
        ...
        protected void SetupFailsafeMasterPage()
        {
            ...
            MPTopPane = (ContentPlaceHolder)Master.FindControl("topContent");
            MPBottomPane = (ContentPlaceHolder)Master.FindControl("bottomContent");
        ...
        public void LoadAltContent(bool includeTop, bool includeBottom)
        {
            ...
            if (MPTopPane == null) { return; }
            if (MPBottomPane == null) { return; }
            ...
            if (CurrentPage.Modules.Count > 0)
            {
                foreach (Module module in CurrentPage.Modules)
                {
                    ...
                    if (ModuleIsVisible(module))
                    {
                        ...
                        if ((includeTop) && (StringHelper.IsCaseInsensitiveMatch(module.PaneName, "topContent")))
                        {
                            Control c = Page.LoadControl("~/" + module.ControlSource);
                            if (c == null) { continue; }
                            ...
                            Control a1 = Master.FindControl("divTop");
                            if (a1 != null)
                            {
                                a1.Visible = true;
                            }
                            ...
                            MPTopPane.Controls.Add(c);

                        }

                        if ((includeBottom) && (StringHelper.IsCaseInsensitiveMatch(module.PaneName, "bottomContent")))
                        {
                            Control c = Page.LoadControl("~/" + module.ControlSource);
                            if (c == null) { continue; }
                            ...
                            Control a2 = Master.FindControl("divBottom");
                            if (a2 != null) { a2.Visible = true; }

                            MPBottomPane.Controls.Add(c);
