                                ...
                                <div class="panelayout">
                                    ...
                                    <div class="pane layoutalt1" id="divAltPanel1" runat="server">
                                        ...
                                        <div class="panelistbox">
                                            <asp:ListBox ID="topPane" runat="server" DataValueField="ModuleID" DataTextField="ModuleTitle"
                                                Rows="7" />
                                            <div class="layoutbuttons">
                                                ...
                                                <asp:ImageButton ID="btnEditAlt1" runat="server" CommandName="edit" CommandArgument="topPane"
                                                    CssClass="btnedit" SkinID="pageLayoutEditSettings" />
                                                <asp:ImageButton ID="btnDeleteAlt1" runat="server" CommandName="delete" CommandArgument="topPane"
                                    ...
                                    <div class="pane layoutalt2" id="divAltPanel2" runat="server">
                                        ...
                                        <div class="panelistbox">
                                            <asp:ListBox ID="bottomPane" runat="server" DataValueField="ModuleID" DataTextField="ModuleTitle"
                                                Rows="7" />
                                            <div class="layoutbuttons">
                                                ...
                                                <asp:ImageButton ID="btnEditAlt2" runat="server" CommandName="edit" CommandArgument="bottomPane"
                                                    SkinID="pageLayoutEditSettings" CssClass="btnedit" />
                                                <asp:ImageButton ID="btnDeleteAlt2" runat="server" CommandName="delete" CommandArgument="bottomPane"
                                                    SkinID="pageLayoutDeleteItem" CssClass="btnremove" />
                                            </div>
                                        </div>
                                    </div>
