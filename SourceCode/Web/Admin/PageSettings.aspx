                    ...
                    <div class="pagetabs">
                        <div id="divtabs" class="mojo-tabs">
                            ...
                            <div id="tabSettings">
                                ...
                                <%-- bat dau cau hinh chuyen muc lay tin tuc --%>
                                <div class="settingrow" style="display:none">
                                    <mp:SiteLabel ID="SiteLabel41" runat="server" ForControl="lbCategory" CssClass="settinglabel" ConfigKey="PageCategoryLabel"></mp:SiteLabel>
                                    <asp:ListBox ID="lbCategory" runat="server" SelectionMode="Multiple" Width="300" Height="150"></asp:ListBox>
                                </div>
                                <%-- ket thuc cau hinh chuyen muc lay tin tuc --%>
                                <%-- bat dau Ke thua tinh nang tu trang mac dinh --%>
                                <div id="divUseDefaultPage" runat="server" class="settingrow">
                                    <mp:SiteLabel ID="Sitelabel42" runat="server" ForControl="chkUseDefault" CssClass="settinglabel"
                                        ConfigKey="PageSettingsUseDefaultLabel"></mp:SiteLabel>
                                    <asp:CheckBox ID="chkUseDefault" runat="server" CssClass="forminput" Checked="true"></asp:CheckBox>
                                </div>
                                <%-- ket thuc Ke thua tinh nang tu trang mac dinh --%>
                                <div class="settingrow">
                                ...
                                <asp:Panel ID="pnRequestLogin" Visible="true" runat="server" CssClass="settingrow">
                                    <mp:SiteLabel ID="Sitelabel43" runat="server" ForControl="cbk_RequestLogin" CssClass="settinglabel"
                                        ConfigKey="RequestLoginLabel"></mp:SiteLabel>
                                    <asp:CheckBox ID="cbk_RequestLogin" runat="server" CssClass="forminput"></asp:CheckBox>
                                </asp:Panel>
