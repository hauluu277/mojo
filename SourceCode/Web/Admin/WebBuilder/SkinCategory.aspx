<%@ Page Language="c#" CodeBehind="SkinCategory.aspx.cs" MasterPageFile="~/App_MasterPages/layout.Master"
    AutoEventWireup="false" Inherits="mojoPortal.Web.AdminUI.SkinCategory" %>
...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    <portal:AdminCrumbContainer ID="pnlAdminCrumbs" runat="server" CssClass="breadcrumbs">
        ...
        <asp:HyperLink ID="lnkSkinManager" runat="server" NavigateUrl="~/Admin/AdminMenu.aspx" /><portal:AdminCrumbSeparator ID="AdminCrumbSeparator2" runat="server" Text="&nbsp;&gt;" EnableViewState="false" />
            ...
            <portal:OuterBodyPanel ID="pnlOuterBody" runat="server">
                <portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
                    ...
                    <div style="width: 100%; float: left; padding: 10px 0; text-align: right">
                        <button class="btn btn-primary" onclick="javascript:CreateCategory(); return false;">Thêm mới danh mục</button>
                    </div>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Thêm mới danh mục thuộc template website</h4>
                    ...
                    <script type="text/javascript">
                        function DeleteCategory(id) {
                            if (confirm("Dữ liệu xóa, sẽ không khôi phục được?")) {
                                $.ajax({
                                    type: "POST",
                                    url: "/Admin/WebBuilder/SkinCategory.aspx/DeleteCategory",
                                    data: '{ id: "' + id + '" }',
                                    cache: false,
