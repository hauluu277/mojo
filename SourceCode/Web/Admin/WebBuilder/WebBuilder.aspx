<%@ Page Language="C#" AutoEventWireup="false" MaintainScrollPositionOnPostback="true"
    MasterPageFile="~/App_MasterPages/layout.Master" CodeBehind="WebBuilder.aspx.cs"
    Inherits="mojoPortal.Web.AdminUI.WebBuilder" %>
                ...
                <portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
                    ...
                    <asp:Panel ID="pnlSiteSettings" runat="server" DefaultButton="btnSave">
                        <div class="settingrow">
                            <label class="settinglabel">Tiêu đề subPortal</label>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtSiteName" ErrorMessage="Bạn chưa nhập tên subPortal" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </div>
                        <div id="divtabs" class="mojo-tabs">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item" id="liSecurity" runat="server" enableviewstate="false" visible="false">
                                ...
                                <li class="nav-item" id="liCommerce" runat="server" enableviewstate="false" visible="false">
                            ...
                            <div id="tabSettings">
                                ...
                                <asp:Panel ID="pnlSkin" runat="server" CssClass="settingrow">
                                    <label class="settinglabel" style="float: left; width: 200px">Template subPortal</label>
                                    <div style="float: left; width: calc(100% - 210px);">
                                        <asp:DropDownList ID="ddlSkins" runat="server"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlSkins" ErrorMessage="Bạn chọn template cuộc điều tra" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                    <%--<portal:mojoHelpLink ID="MojoHelpLink69" runat="server" HelpKey="meta-profile-help" />--%>
                                </asp:Panel>
                                <div class="settingrow hide">
                                ...
                                <asp:Panel ID="pnlNamCuocDieuTra" runat="server" Visible="false" CssClass="settingrow hide">
                                    <label class="settinglabel" style="float: left; width: 200px">Năm cuộc điều tra</label>
                                    <div style="float: left; width: calc(100% - 210px);">
                                        <asp:DropDownList ID="ddlNamCuocDieuTra" runat="server" CssClass="select2"></asp:DropDownList>
                                ...
                                <asp:Panel ID="pnlUrlSiteMap" runat="server" CssClass="settingrow sitemap hide">
                                    <label class="settinglabel">Url subPortal</label>
                                    <asp:TextBox ID="txtUrlSiteMap" runat="server" MaxLength="250"
                                        CssClass="forminput widetextbox" />
                                    <portal:mojoLabel ID="lblSiteMapError" runat="server" CssClass="txterror info" />
                                </asp:Panel>

                                <asp:Panel ID="pnlUrlSubDomain" runat="server" CssClass="settingrow sitemap">
                                    <label class="settinglabel">Url subdomain</label>
                                    <asp:TextBox ID="txtSubdomain" runat="server" MaxLength="250"
                                        CssClass="forminput widetextbox" />
                                    <portal:mojoLabel ID="lblSubdomainError" runat="server" CssClass="txterror info" />
                                </asp:Panel>
                                <asp:Panel ID="Panel1" runat="server" CssClass="settingrow sitemap hide" Visible="false">
                                    <label class="settinglabel" style="float: left; width: 200px">Lĩnh vực điều tra</label>
                                    <div style="float: left; width: calc(100% - 210px);">
                                ...
                                <div class="settingrow sitemap hide">
                                ...
                                <div id="divSiteIsClosed" runat="server" class="settingrow" visible="false">
                                ...
                                <div id="divMobileSkin" runat="server" class="settingrow" visible="false">
                                ...
                                <div class="settingrow logolist">
                                    ...
                                    <p>
                                        ...
                                        <asp:Label ID="lblLogoError" runat="server" ForeColor="Red"></asp:Label>
                                        <asp:Button ID="btnUploadFile" runat="server" Text="Upload Logo" CssClass="btn btn-default" />
                                    </p>
                                    <div style="float: left; margin-left: 200px; width:350px">
                                        <asp:DropDownList ID="ddLogos" runat="server" TabIndex="10" EnableViewState="true"
                                            DataValueField="Name" DataTextField="Name" CssClass="forminput m-left200">
                                        </asp:DropDownList>
                                ...
                                <div class="settingrow" style="display: none">
                                    ...
                                    <asp:DropDownList ID="ddEditorProviders" DataTextField="name" DataValueField="name"
                                        EnableViewStateddAvatarSystem="true" TabIndex="10" runat="server" CssClass="forminput">
                                    </asp:DropDownList>
                                ...
                                <div class="settingrow" style="display: none">
                                    ...
                                    <asp:DropDownList ID="ddAvatarSystem" DataTextField="name" DataValueField="name"
                                        ...
                                        <asp:ListItem Value="internal" Selected="True" Text="<%$ Resources:Resource, AvatarTypeInternal %>"></asp:ListItem>
                                ...
                                <div id="divAllowUserSkins" runat="server" class="settingrow" style="display: none">
                                ...
                                <div id="divAllowPageSkins" runat="server" class="settingrow" style="display: none">
                                ...
                                <div id="divAllowHideMenu" runat="server" class="settingrow" style="display: none">
                                ...
                                <div id="divMyPage" runat="server" class="settingrow" style="display: none">
                                ...
                                <div id="divMyPageSkin" runat="server" class="settingrow" style="display: none">
                                ...
                                <div id="divSSL" runat="server" class="settingrow" style="display: none">
                                ...
                                <div id="divContentVersioning" runat="server" class="settingrow" visible="false">
                            ...
                            <div id="tabCompanyInfo" style="display: none">
                                <div class="settingrow">
                                    <mp:SiteLabel ID="SiteLabel47" runat="server" ForControl="txtCompanyName" CssClass="settinglabel"
                                        ConfigKey="BanQuyenLabel" EnableViewState="false" />
                                    <asp:TextBox ID="txtCompanyName" runat="server" Width="75%" TabIndex="10" MaxLength="150" CssClass="forminput verywidetextbox" />
                                ...
                                <div class="settingrow">
                                    <mp:SiteLabel ID="SiteLabel42" runat="server" ForControl="txtStreetAddress" CssClass="settinglabel"
                                        ConfigKey="DiaChiLabel" EnableViewState="false" />
                                    <asp:TextBox ID="txtStreetAddress" runat="server" Width="75%" TabIndex="10" MaxLength="150" CssClass="forminput verywidetextbox" />
                                </div>
                                <div class="settingrow">
                                    <mp:SiteLabel ID="SiteLabel77" runat="server" ForControl="txtStreetAddress2" CssClass="settinglabel"
                                        ConfigKey="CoQuanChuQuanLabel" EnableViewState="false" />
                                    <asp:TextBox ID="txtStreetAddress2" runat="server" Width="75%" TabIndex="10" MaxLength="150" CssClass="forminput verywidetextbox" />
                                </div>
                                <div class="settingrow">
                                    <mp:SiteLabel ID="SiteLabel43" runat="server" ForControl="txtLocality" CssClass="settinglabel"
                                        ConfigKey="ChiuTrachNhiemLabel" EnableViewState="false" />
                                    <asp:TextBox ID="txtLocality" runat="server" TabIndex="10" Width="75%" MaxLength="150" CssClass="forminput widetextbox" />
                                </div>
                                <div class="settingrow">
                                    <mp:SiteLabel ID="SiteLabel66" runat="server" ForControl="txtRegion" CssClass="settinglabel"
                                        ConfigKey="GiayPhepLabel" EnableViewState="false" />
                                    <asp:TextBox ID="txtRegion" runat="server" TabIndex="10" Width="75%" MaxLength="150" CssClass="forminput widetextbox" />
                                </div>
                                <div class="settingrow">
                                    <mp:SiteLabel ID="SiteLabel67" runat="server" ForControl="txtPostalCode" CssClass="settinglabel"
                                        ConfigKey="GhiNguonLabel" EnableViewState="false" />
                                    <asp:TextBox ID="txtPostalCode" runat="server" TabIndex="10" Width="75%" MaxLength="150" CssClass="forminput normaltextbox" />
                                </div>
                                <div class="settingrow">
                                    <mp:SiteLabel ID="SiteLabel68" runat="server" ForControl="txtCountry" CssClass="settinglabel"
                                        ConfigKey="TelLabel" EnableViewState="false" />
                                    <asp:TextBox ID="txtCountry" runat="server" TabIndex="10" Width="75%" MaxLength="150" CssClass="forminput widetextbox" />
                                </div>
                                <div class="settingrow">
                                    <mp:SiteLabel ID="SiteLabel69" runat="server" ForControl="txtPhone" CssClass="settinglabel"
                                        ConfigKey="Phone" EnableViewState="false" />
                                    <asp:TextBox ID="txtPhone" runat="server" TabIndex="10" Width="75%" MaxLength="100" CssClass="forminput normaltextbox" />
                                </div>
                                <div class="settingrow">
                                    <mp:SiteLabel ID="SiteLabel70" runat="server" ForControl="txtFax" CssClass="settinglabel"
                                        ConfigKey="Fax" EnableViewState="false" />
                                    <asp:TextBox ID="txtFax" runat="server" TabIndex="10" Width="75%" MaxLength="100" CssClass="forminput normaltextbox" />
                                </div>
                                <div class="settingrow">
                                    <mp:SiteLabel ID="SiteLabel71" runat="server" ForControl="txtPublicEmail" CssClass="settinglabel"
                                        ConfigKey="EmailLabel" EnableViewState="false" />
                                    <asp:TextBox ID="txtPublicEmail" runat="server" TabIndex="10" Width="75%" MaxLength="100" CssClass="forminput widetextbox" />
                                </div>
                            </div>
                            <div id="tabCommerce" runat="server" visible="false">
                                <div class="settingrow">
