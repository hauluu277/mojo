<%@ Page Language="C#" AutoEventWireup="false" MaintainScrollPositionOnPostback="true"
    MasterPageFile="~/App_MasterPages/layout.Master" CodeBehind="WebBuilderInfor.aspx.cs"
    Inherits="mojoPortal.Web.AdminUI.WebBuilderInfor" %>
                        ...
                        <div id="divtabs" class="mojo-tabs">
                            ...
                            <div id="tabSettings">
                                ...
                                <asp:Panel ID="pnlSkin" runat="server" CssClass="settingrow">
                                    <mp:SiteLabel ID="SiteLabel113" runat="server" ForControl="ddlSkins" CssClass="settinglabel"
                                        ConfigKey="SkinTemplateLabel" EnableViewState="false" />
                                ...
                                <asp:Panel ID="pnlUrlSiteMap" runat="server" CssClass="settingrow sitemap">
                                    <mp:SiteLabel ID="SiteLabel98" runat="server" ForControl="ddDefaultFriendlyUrlPattern"
                                ...
                                <asp:Panel ID="pnlUrlSubDomain" runat="server" CssClass="settingrow sitemap">
                                    <label class="settinglabel">Địa chỉ subdomain</label>
