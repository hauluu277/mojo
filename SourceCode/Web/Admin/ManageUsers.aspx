<%@ Page Language="c#" MaintainScrollPositionOnPostback="true" CodeBehind="ManageUsers.aspx.cs"
    MasterPageFile="~/App_MasterPages/layout.Master" EnableEventValidation="false" AutoEventWireup="false" Inherits="mojoPortal.Web.AdminUI.ManageUsers" %>
                ...
                <br /> --%>
                            <div id="divtabs" class="mojo-tabs">
                                ...
                                <div id="tabSecurity">
                                    ...
                                    <div id="div2" runat="server" class="settingrow">
                                        <label class="settinglabel">Đơn vị</label>
                                ...
                                <div id="tabRoles" runat="server">
                                    ...
                                    <asp:Panel ID="pnlRolePortal" runat="server" CssClass="settingrow" Visible="false">
                                        <label class="settinglabel">Phân quyền cho portal</label>
                                        <asp:ListBox ID="lboxSiteUse" runat="server" SelectionMode="Multiple"></asp:ListBox>
                                    </asp:Panel>
                                </div>
                                <div id="tabActivity" runat="server">
                                    ...
                                    <div id="divUserGuid" runat="server" class="settingrow">
                                        <mp:SiteLabel ID="lblUserGuidLabel" runat="server" CssClass="settinglabel" ConfigKey="ManageUsersUserGuidLabel"></mp:SiteLabel>
                                        <asp:Label ID="lblUserGuid" runat="server" CssClass="forminput"></asp:Label>
                                    </div>
                                    <div id="divLastActivity" runat="server" class="settingrow">
                                        <mp:SiteLabel ID="SiteLabel3" runat="server" CssClass="settinglabel" ConfigKey="UserLastActivityDateLabel"></mp:SiteLabel>
                                    ...
                                    <div id="divLastLogin" runat="server" class="settingrow">
                                        <mp:SiteLabel ID="SiteLabel4" runat="server" CssClass="settinglabel" ConfigKey="UserLastLoginDateLabel"></mp:SiteLabel>
                                    ...
                                    <div id="divPasswordChanged" runat="server" class="settingrow">
                                        <mp:SiteLabel ID="SiteLabel5" runat="server" CssClass="settinglabel" ConfigKey="UserLastPasswordChangeDateLabel"></mp:SiteLabel>
                                    ...
                                    <div id="divLockoutDate" runat="server" class="settingrow">
                                        <mp:SiteLabel ID="SiteLabel6" runat="server" CssClass="settinglabel" ConfigKey="UserLastLockoutDateLabel"></mp:SiteLabel>
                                    ...
                                    <div id="divFailedPasswordAttempt" runat="server" class="settingrow">
                                        <mp:SiteLabel ID="SiteLabel7" runat="server" CssClass="settinglabel" ConfigKey="UserFailedPasswordAttemptCountLabel"></mp:SiteLabel>
                                    ...
                                    <div id="divFailedPasswordAnswerAttempt" runat="server" class="settingrow">
                                        <mp:SiteLabel ID="SiteLabel8" runat="server" CssClass="settinglabel" ConfigKey="UserFailedPasswordAnswerAttemptCountLabel"></mp:SiteLabel>
                            ...
                            <div class="settingrow">
                                ...
                                <portal:mojoButton ID="btnUpdate" runat="server" CausesValidation="false" ValidationGroup="profile" />
                                <portal:mojoButton ID="btnDelete" runat="server" CausesValidation="false" />
                                <portal:mojoButton ID="btnResetPassword" runat="server" CausesValidation="false"  Text="Guiwr" /><br />
                    ...
                    <script>
                        function ReloadTag() {
                            $("#<%=lboxSiteUse.ClientID%>").fastselect({ placeholder: "--Danh sách portal--" });
                        }
