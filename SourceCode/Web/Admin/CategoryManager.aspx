<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master" CodeBehind="CategoryManager.aspx.cs" Inherits="mojoPortal.Web.AdminUI.CategoryManager" %>
                ...
                <portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
                    ...
                    <script type="text/javascript">
                        ...
                        function LoadTree() {
                            ...
                            CallAjaxLoading("post", "/CategoryArea/Category/GetList", JSON.stringify(param), true, function (rs) {
                                $('#tree1').tree({
                                    data: rs,
                                    autoOpen:false,
                                    dragAndDrop: true,
                            ...
                            $('#tree1').on(
                                ...
                                function (event) {
                                    if (event.node) {
                                        ...
                                        //html += `<a id="lnkedit" class="" href="javascript:PhanMucChuyenMuc(${node.id},0)">`;
                                        //html += 'phân quyền chuyên mục';
                                        //html += '</a>';
                                        //html += '</li>';
