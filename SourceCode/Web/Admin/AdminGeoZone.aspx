                    ...
                    <mp:mojoGridView ID="grdGeoZone" runat="server" AllowPaging="false" AllowSorting="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <EditItemTemplate>
                                    <asp:CheckBox ID="ckbIs_Weather" Columns="20" Checked='<%# Eval("Is_Weather") %>' Text='<%# Eval("Is_Weather") %>' runat="server" />
                                </EditItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtOrderBy" Columns="10" Text='<%# Eval("OrderBy") %>' runat="server"
                                        MaxLength="9" />
                                </EditItemTemplate>
                            </asp:TemplateField>
                        </Columns>
