...
namespace mojoPortal.Web.AdminUI 
{
    public partial class ModuleDefinitions : NonCmsBasePage
	{
        ...
        {
            Title = SiteUtils.FormatPageTitle(siteSettings, "CÀI ĐẶT VÀ CẤU HÌNH NHÓM CHỨC NĂNG");

            heading.Text = "CÀI ĐẶT VÀ CẤU HÌNH NHÓM CHỨC NĂNG";

            lnkAdminMenu.Text = Resource.AdminMenuLink;
            lnkAdminMenu.ToolTip = Resource.AdminMenuLink;
            lnkAdminMenu.NavigateUrl = SiteRoot + "/Admin/AdminMenu.aspx";
            lnkModuleAdmin.Text = "CÀI ĐẶT VÀ CẤU HÌNH NHÓM CHỨC NĂNG";
            lnkModuleAdmin.ToolTip = "CÀI ĐẶT VÀ CẤU HÌNH NHÓM CHỨC NĂNG";
