...
namespace mojoPortal.Web.AdminUI
{
    public partial class ModuleAdminPage : NonCmsBasePage
    {
        ...
        {
            Title = SiteUtils.FormatPageTitle(siteSettings, "Quản lý nhóm chức năng");
            heading.Text = "Quản lý nhóm chức năng";
            ...
            lnkFeatureAdmin.Text = "Quản lý nhóm chức năng";
            lnkFeatureAdmin.ToolTip = "Quản lý nhóm chức năng";
            lnkFeatureAdmin.NavigateUrl = SiteRoot + "/Admin/ModuleAdmin.aspx";

            lnkNewModule.Text = "Thêm mới nhóm chức năng";
            lnkNewModule.ToolTip = "Thêm mới nhóm chức năng";
