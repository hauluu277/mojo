...
{
    public partial class CategoryArticle : NonCmsBasePage
    {
        ...
        private bool AccessRole()
        {
            ...
            if (!WebUser.IsInRoles(WebConfigSettings.RoleApprovedArticle))
            {
                return false;
            }
            return true;
        ...
        private void BindGrid()
        {
            ...
            if (parentid > 0)
            {
                parents = CoreCategory.GetParent(Convert.ToInt32(parentid));
            }
            else
            {
                parents = CoreCategory.GetParent(Convert.ToInt32(siteSettings.ArticleCategory));
            }
            
            List<CoreCategory> categories = CoreCategory.GetPageArticle(SiteId, pageNumber, pageSize, keyword, parentid, parents, out totalPages);
            ...
            {
                string pageUrl = SiteRoot + "/Admin/CategoryArticle.aspx?pagenumber={0}&amp;sort=" + sort + "&amp;key=" + keyword + "&amp;parentid=" + parentid;
        ...
        private void grdContentCategory_Sorting(object sender, GridViewSortEventArgs e)
        {
            String redirectUrl = SiteRoot
                + "/Admin/CategoryArticle.aspx?pagenumber=" + pageNumber.ToString(CultureInfo.InvariantCulture)
        ...
        {
            string url = SiteRoot + "/Admin/FormCategory.aspx";
        ...
        private void PopulateLabels()
        {
            ...
            Title = SiteUtils.FormatPageTitle(siteSettings, "Quản trị chuyên mục tin bài");

            lnkAdminMenu.Text = Resource.AdminMenuLink;
            lnkAdminMenu.NavigateUrl = SiteRoot + "/Admin/AdminMenu.aspx";

            lnkCurrentPage.Text = "Quản trị chuyên mục tin bài";
            lnkCurrentPage.NavigateUrl = SiteRoot + "/Admin/CategoryArticle.aspx";

            heading.Text = "Quản trị chuyên mục tin bài";
            ...
            this.grdContentCategory.Columns[0].HeaderText = Resource.CoreCategoryGridNameHeader;
            ...
            btnAddNew.Text = "Thêm mới chuyên mục";
            btnAddNewTop.Text = "Thêm mới chuyên mục";
        ...
        private void grdContentCategory_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "EditItem")
            {
                ...
                string url = SiteRoot + "/Admin/FormCategory.aspx?item=" + itemid;
                WebUtils.SetupRedirect(this, url);
            }
