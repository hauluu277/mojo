...
namespace mojoPortal.Web.AdminUI 
{
    ...
    public partial class PageLayout : NonCmsBasePage
	{
        ...
        private void BindPanes()
        {
            ...
            {
                BindPaneModules(contentPane, "topPane");
            }
            ...
            {
                BindPaneModules(contentPane, "bottomPane");
            }
        ...
        private void PopulateLabels()
        {
            ...
            this.divAltPanel1.Visible = pageHasTopContent;
            this.divAltPanel2.Visible = pageHasBottomContent;
            ContentUpToNextButton.Visible = pageHasTopContent;
            ContentDownToNextButton.Visible = pageHasBottomContent;

            if (pageHasTopContent || pageHasBottomContent)
            {
