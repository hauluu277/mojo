                    ...
                    <portal:BasePanel ID="pnlSiteSettings" runat="server" DefaultButton="btnSave" RenderId="false">
                        ...
                        <div id="divtabs" class="mojo-tabs">
                            <ul>
                                ...
                                <li class="hide" id="liCommerce" runat="server" enableviewstate="false">
                            ...
                            <div id="tabSettings">
                                <portal:FormGroupPanel runat="server" SkinID="MainSettings">
                                    ...
                                    <portal:FormGroupPanel runat="server" CssClass="hide" ID="fgpSiteId" Visible="false">
                                    ...
                                    <div class="settingrow">
                                        <mp:SiteLabel ID="SiteLabel98" ForControl="ddlCoreCategory" runat="server" CssClass="settinglabel"
                                            ConfigKey="SiteSettingsCoreCategoryLabel" EnableViewState="false"></mp:SiteLabel>
                                        <asp:DropDownList ID="ddlCoreCategory" runat="server"></asp:DropDownList>
                                    </div>
                                    <%--01. Hết--%>
                                    <%--02. Danh mục sự kiện--%>
                                    <div class="settingrow hide">
                                        <mp:SiteLabel ID="SiteLabel104" ForControl="ddlCoreEventCategory" runat="server" CssClass="settinglabel"
                                            ConfigKey="SiteSettingsCoreEventCategoryLabel" EnableViewState="false"></mp:SiteLabel>
                                        <asp:DropDownList ID="ddlCoreEventCategory" runat="server"></asp:DropDownList>
                                    </div>
                                    <%--02. Hết--%>
                                    <%--03. Danh mục loại văn bản quy phạm--%>
                                    <div class="settingrow hide">
                                        <mp:SiteLabel ID="SiteLabel99" ForControl="ddlCoreLoaiVanBanQuyPham" runat="server" CssClass="settinglabel"
                                            ConfigKey="SiteSettingsCoreLoaiVanBanQuyPhamLabel" EnableViewState="false"></mp:SiteLabel>
                                        <asp:DropDownList ID="ddlCoreLoaiVanBanQuyPham" runat="server"></asp:DropDownList>
                                    </div>
                                    <%--03. Hết--%>
                                    <%--04. Danh mục lĩnh vực văn bản quy phạm--%>
                                    <div class="settingrow hide">
                                        <mp:SiteLabel ID="SiteLabel105" ForControl="ddlCoreLinhVucVanBanQuyPham" runat="server" CssClass="settinglabel"
                                            ConfigKey="SiteSettingsCoreLinhVucVanBanQuyPhamLabel" EnableViewState="false"></mp:SiteLabel>
                                        <asp:DropDownList ID="ddlCoreLinhVucVanBanQuyPham" runat="server"></asp:DropDownList>
                                    </div>
                                    <%--04. Hết--%>
                                    <%--05. Danh mục cơ quan ban hành văn bản quy phạm--%>
                                    <div class="settingrow hide">
                                        <mp:SiteLabel ID="SiteLabel106" ForControl="ddlCoreCoQuanBanHanhVanBanQuyPham" runat="server" CssClass="settinglabel"
                                            ConfigKey="SiteSettingsCoreCoQuanBanHanhVanBanQuyPhamLabel" EnableViewState="false"></mp:SiteLabel>
                                        <asp:DropDownList ID="ddlCoreCoQuanBanHanhVanBanQuyPham" runat="server"></asp:DropDownList>
                                    </div>
                                    <%--05. Hết--%>
                                    <%--06. Danh mục đơn vị phòng ban--%>
                                    <div class="settingrow hide">
                                        <label class="settinglabel">Danh mục tin bài giới thiệu</label>
                                        <asp:DropDownList ID="ddlCoreDonVi" runat="server"></asp:DropDownList>
                                    </div>
                                    <%--06. Hết--%>
                                    <%--07. Loại tư vấn tuyển sinh--%>
                                    <div class="settingrow hide">
                                        <label class="settinglabel">Loại tư vấn tuyển sinh</label>
                                        <asp:DropDownList ID="ddlCoreHoiDong" runat="server"></asp:DropDownList>
                                    </div>
                                    <%--07. Hết--%>
                                    <%--08. Danh mục lĩnh vực hỏi đáp--%>
                                    <div class="settingrow">
                                        <mp:SiteLabel ID="SiteLabel108" ForControl="ddlCoreLinhVucHoiDap" runat="server" CssClass="settinglabel"
                                            ConfigKey="SiteSettingsCoreLinhVucHoiDapLabel" EnableViewState="false"></mp:SiteLabel>
                                        <asp:DropDownList ID="ddlCoreLinhVucHoiDap" runat="server"></asp:DropDownList>
                                    </div>
                                    <%--08. Hết--%>
                                    <%--08. Danh mục dữ liệu đa phương tiện--%>
                                    <div class="settingrow">
                                        <mp:SiteLabel ID="SiteLabel109" ForControl="ddlCoreDuLieuDaPhuongTien" runat="server" CssClass="settinglabel"
                                            ConfigKey="SiteSettingsCoreDuLieuDaPhuongTienLabel" EnableViewState="false"></mp:SiteLabel>
                                        <asp:DropDownList ID="ddlCoreDuLieuDaPhuongTien" runat="server"></asp:DropDownList>
                                    </div>
                                    <%--08. Hết--%>
                                    <%--10. Danh mục nguồn cấp tin--%>
                                    <div class="settingrow hide">
                                        <mp:SiteLabel ID="SiteLabel110" ForControl="ddlCoreRSS" runat="server" CssClass="settinglabel"
                                            ConfigKey="SiteSettingsCoreRSSLabel" EnableViewState="false"></mp:SiteLabel>
                                        <asp:DropDownList ID="ddlCoreRSS" runat="server"></asp:DropDownList>
                                    </div>
                                    <%--10. Hết--%>
                                    <%--11. Danh mục chủ đề văn bản pháp quy--%>
                                    <div class="settingrow hide">
                                        <mp:SiteLabel ID="SiteLabel112" ForControl="ddlCoreChuDe" runat="server" CssClass="settinglabel"
                                            ConfigKey="SiteSettingsCoreChuDeLabel" EnableViewState="false"></mp:SiteLabel>
                                        <asp:DropDownList ID="ddlCoreChuDe" runat="server"></asp:DropDownList>
                                    </div>
                                    <%--11. Hết--%>
                                    ...
                                    <portal:FormGroupPanel runat="server" CssClass="hide" ID="fgpContentVersioning">
                                    ...
                                    <portal:FormGroupPanel runat="server" CssClass="hide" ID="fgpApprovalsWorkflow">
                                    ...
                                    <portal:FormGroupPanel runat="server" CssClass="hide">
                                ...
                                <portal:FormGroupPanel runat="server" SkinID="SkinSettings">
                                    ...
                                    <portal:FormGroupPanel runat="server" CssClass="hide" ID="fgpAllowUserSkins">
                                    ...
                                    <portal:FormGroupPanel runat="server" CssClass="logolist">
                                        ...
                                        <p>
                                            ...
                                            <asp:Button ID="btnUploadFile" runat="server" Text="Upload Logo" />
                                        </p>
                                    ...
                                    <portal:FormGroupPanel runat="server">
                                        <label class="settinglabel">Sub Slogan</label>
                                        <asp:TextBox ID="txtSubTitle" runat="server" TabIndex="10" MaxLength="100" CssClass="forminput widetextbox" />
                                    </portal:FormGroupPanel>
                                </portal:FormGroupPanel>
                            ...
                            <div id="tabSecurity" runat="server">
                                <div id="divSecurityTabs" class="mojo-tabs">
                                    <ul>
                                        ...
                                        <li class="hide" id="lithirdpartyauth" runat="server" enableviewstate="false">
                                    ...
                                    <div id="tabGeneralSecurity" runat="server">
                                        ...
                                        <portal:FormGroupPanel runat="server" SkinID="PasswordSettings">
                                            ...
                                            <portal:FormGroupPanel runat="server" SkinID="PasswordRecoverySettings">
                                                ...
                                                <portal:FormGroupPanel runat="server">
                                                    <label class="settinglabel">Giao diện hiển thị trang đăng ký?</label>
                                                    <asp:DropDownList ID="ddlGiaoDienDangKy" runat="server"></asp:DropDownList>
                                                </portal:FormGroupPanel>
                                            </portal:FormGroupPanel>
                                        </portal:FormGroupPanel>
                                    </div>
