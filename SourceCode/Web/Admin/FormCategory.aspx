<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="FormCategory.aspx.cs" Inherits="mojoPortal.Web.AdminUI.FormCategory" MasterPageFile="~/App_MasterPages/layout.Master" %>
                ...
                <portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
                    <ol class="formlist">
                        <li class="settingrow">
                            ...
                            <asp:TextBox ID="txtName" Width="65%" runat="server"></asp:TextBox>
                        ...
                        <li class="settingrow">
                            <label class="settinglabel">Biên tập viên:</label>
                            <div class="checkbox checkbox-primary width16em">
                                <asp:CheckBoxList ID="cblBienTapVien" runat="server"></asp:CheckBoxList>
                            </div>
                        </li>
                       <li class="settingrow">
                            <label class="settinglabel">Kiểm duyệt và xuất bản:</label>
                            <div class="checkbox checkbox-primary width16em">
                                <asp:CheckBoxList ID="cblKiemDuyetVien" runat="server"></asp:CheckBoxList>
                            </div>
                        </li>
                        <li class="settingrow">
