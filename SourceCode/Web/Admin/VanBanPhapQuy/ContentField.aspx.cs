...
{
    public partial class ContentField : NonCmsBasePage
    {
        ...
        private void BindGrid()
        {
            ...
            List<LinhVuc> fields = LinhVuc.GetPage(siteSetting.SiteId, pageNumber, pageSize, keyword, out totalPages);
            Comparison<LinhVuc> sortComparer;

            switch (sort)
            {
                case "Description":
                    sortComparer
                        = new Comparison<LinhVuc>(LinhVuc.CompareByDescription);
                    break;

                case "Name":
                default:
                    sortComparer
                        = new Comparison<LinhVuc>(LinhVuc.CompareByName);
                    break;
            }
            ...
            {
                string pageUrl = SiteRoot + "/Admin/VanBanPhapQuy/ContentField.aspx?pagenumber={0}&amp;sort=" + sort + "&amp;key=" + keyword;
        ...
        private void grdContentField_Sorting(object sender, GridViewSortEventArgs e)
        {
            String redirectUrl = SiteRoot
                + "/Admin/VanBanPhapQuy/ContentField.aspx?pagenumber=" + pageNumber.ToString(CultureInfo.InvariantCulture)
        ...
        private void grdContentField_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                fields = new LinhVuc(itemId);
            }

            fields.Name = txtName.Text;
            //fields.NameEN = txtNameEN.Text;
            fields.SiteID = siteSettings.SiteId;
            ...
            fields.CreatedUtc = DateTime.UtcNow;
            fields.CreatedBy = siteUser.UserGuid;
        ...
        private void PopulateLabels()
        {
            ...
            lnkCurrentPage.NavigateUrl = SiteRoot + "/Admin/VanBanPhapQuy/ContentField.aspx";
