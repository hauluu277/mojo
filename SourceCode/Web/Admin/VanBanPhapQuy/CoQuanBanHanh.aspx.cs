...
{
    public partial class CoQuanBanHanh : NonCmsBasePage
    {
        ...
        private void BindGrid()
        {
            ...
            List<CoQuan> cq = CoQuan.GetPage(siteSetting.SiteId, pageNumber, pageSize, keyword, out totalPages);
            Comparison<CoQuan> sortComparer;

            switch (sort)
            {
                case "Description":
                    sortComparer
                        = new Comparison<CoQuan>(CoQuan.CompareByDescription);
                    break;

                case "Name":
                default:
                    sortComparer
                        = new Comparison<CoQuan>(CoQuan.CompareByName);
                    break;
            }
            ...
            {
                string pageUrl = SiteRoot + "/Admin/VanBanPhapQuy/CoQuanBanHanh.aspx?pagenumber={0}&amp;sort=" + sort + "&amp;key=" + keyword;
        ...
        private void grdContentField_Sorting(object sender, GridViewSortEventArgs e)
        {
            String redirectUrl = SiteRoot
                + "/Admin/VanBanPhapQuy/CoQuanBanHanh.aspx?pagenumber=" + pageNumber.ToString(CultureInfo.InvariantCulture)
        ...
        private void grdContentField_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            cq.CreatedUtc = DateTime.UtcNow;
            cq.CreatedBy = siteUser.UserGuid;
        ...
        private void PopulateLabels()
        {
            ...
            lnkCurrentPage.NavigateUrl = SiteRoot + "/Admin/VanBanPhapQuy/CoQuanBanHanh.aspx";
