...
{
    public partial class CategoryManager : NonCmsBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!WebUser.IsInRoles(WebConfigSettings.RoleManageCategory))
            {
        ...
        private void PopulateLabels()
        {
            ...
            Title = SiteUtils.FormatPageTitle(siteSettings, "Quản lý danh mục");

            heading.Text = "Quản lý danh mục";
            ...
            lnkPageTree.Text = "Quản lý danh mục";
            lnkPageTree.NavigateUrl = SiteRoot + "/Admin/CategoryManager.aspx";
