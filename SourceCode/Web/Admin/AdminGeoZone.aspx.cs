...
namespace mojoPortal.Web.AdminUI
{
    public partial class AdminGeoZonePage : NonCmsBasePage
    {
        ...
        private void grdGeoZone_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            CheckBox cbkWeather = (CheckBox)grid.Rows[e.RowIndex].Cells[1].FindControl("ckbIs_Weather");
            ...
            geoZone.Is_Weather = cbkWeather.Checked;
            if (!string.IsNullOrEmpty(txtOrderBy.Text))
            {
                geoZone.OrderBy = int.Parse(txtOrderBy.Text);
            }
            geoZone.Save();
        ...
        private void PopulateLabels()
        {
            ...
            grdGeoZone.Columns[3].HeaderText = "Hiển thị thời tiết";
            grdGeoZone.Columns[4].HeaderText = "#";
