...
namespace mojoPortal.Web.AdminUI
{
    public partial class ModuleSettingsPage : NonCmsBasePage
    {
        ...
        private string referrerUrl = string.Empty;
        ...
        private void btnSave_Click(Object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                if (allSetingsAreValid)
                {
                    ...
                    WebUtils.SetupRedirect(this, referrerUrl);
                    return;
                }
            }
        }
        ...
        private void LoadSettings()
        {
            ...
            if (!IsPostBack)
            {
                object refUrl = Request.UrlReferrer;
                if (refUrl != null && refUrl.ToString().Contains("/Admin/WebBuilder/PageBuilder.aspx"))
                {
                    referrerUrl = refUrl.ToString();
                }
                else
                {
                    referrerUrl = SiteUtils.GetCurrentPageUrl();
                }
                Session["urlReferModule"] = referrerUrl;
            }
            else
            {
                object urlRef = Session["urlReferModule"];
                if (urlRef != null)
                {
                    referrerUrl = (string)urlRef;
                }
            }
            lnkCancel.NavigateUrl = referrerUrl;
