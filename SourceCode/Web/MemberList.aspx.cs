...
namespace mojoPortal.Web.UI.Pages
{
    public partial class MemberList : NonCmsBasePage
    {
        ...
        private void BindAlphaList()
        {
            ...
            List<SiteUser> siteUserPage = new List<SiteUser>();
       ...
       out totalPages);
            ...
            {
                siteUserPage = SiteUser.GetPageSync(
       siteSettings.SiteId,
       pageNumber,
       pageSize,
       userNameBeginsWith,
       ...
       out totalPages);
            ...
            {
                txtSearchUser.Text = userNameBeginsWith;
            }
        ...
        private void BindSiteManage()
        {
            ddlSiteManager.Visible = canManageUsers;
            if (canManageUsers)
            {
                ddlSiteManager.DataValueField = "SiteID";
                ddlSiteManager.DataTextField = "SiteName";
                ddlSiteManager.DataSource = SiteSettings.GetListAllSite();
                ddlSiteManager.DataBind();
                ddlSiteManager.Items.Insert(0, new ListItem { Text = "--Tất cả--", Value = "" });
                ddlSiteManager.SelectedValue = site.ToString();
            }
        }
        ...
        private void BindForSearch()
        {
            ...
            else
            {
                ...
                {
                    // admins can also search against email address
                    siteUserPage = SiteUser.GetUserAdminSearchPageSync(
                            siteSettings.SiteId,
                            pageNumber,
                            pageSize,
                            searchText,
                ...
                {
                    siteUserPage = SiteUser.GetUserSearchPageSync(
                            siteSettings.SiteId,
                            pageNumber,
                            pageSize,
                            searchText,
        ...
        void btnSearchUser_Click(object sender, EventArgs e)
        {
            if (canManageUsers)
            {
                string pageUrl = SiteRoot + "/MemberList.aspx?search=" + txtSearchUser.Text + "&site=" + ddlSiteManager.SelectedValue + "&pagenumber=";
                WebUtils.SetupRedirect(this, pageUrl);

            }
            else
            {
                string pageUrl = SiteRoot + "/MemberList.aspx?search=" + txtSearchUser.Text + "&pagenumber=";
                WebUtils.SetupRedirect(this, pageUrl);
        ...
        void BindLockedUsers()
        {
            ...
            {
                siteUserPage = SiteUser.GetPageLockedUsersSync(
                siteSettings.SiteId,
                pageNumber,
                pageSize,
                out totalPages);
        ...
        void BindNotApprovedUsers()
        {
            ...
            {
                siteUserPage = SiteUser.GetNotApprovedUsersSync(
                siteSettings.SiteId,
                pageNumber,
                pageSize,
                out totalPages);
        ...
        private void LoadSettings()
        {
            ...
            site = WebUtils.ParseInt32FromQueryString("site", site);
