        ...
        <portal:OuterBodyPanel ID="pnlOuterBody" runat="server">
            <portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent container">
                ...
                <asp:Panel ID="pnlGallerySlider" runat="server">
                    ...
                    <link href="/Data/plugins/lightslider/css/lightslider.min.css" rel="stylesheet" />
                    <script src="/Data/plugins/lightslider/js/lightslider.min.js"></script>
                    ...
                    <script>
                        $(document).ready(function () {
                            var item = <%=config.GalleryHienThiSetting%>;
                            if (item == 0) {
                                item = 100;
                            }
