...
<div class="width100">
    <fieldset class="fieldset">
        <legend class="legend">Tìm kiếm hình ảnh</legend>
...
<asp:Panel ID="pnlPostList" runat="server">
    <asp:Repeater ID="rptMedia" runat="server" SkinID="Blog">
        <HeaderTemplate>
            <table id="myTable" style="width: 100%" class="table table-bordered">
                <tr>
                    ...
                    <th class="tbl-header" style="width: 15%">Phóng sự ảnh
                    </th>
        ...
        <ItemTemplate>
            <tr>
                <td>
                    <asp:Panel runat="server" ID="Panel4" Visible='<%#AccessDelete(Convert.ToInt32(Eval("GroupMediaID"))) %>'>
                ...
                <td style="vertical-align: top;">
                    <asp:Panel runat="server" ID="Panel1" Visible='<%#AccessDelete(Convert.ToInt32(Eval("GroupMediaID"))) %>'>
                ...
                <td style="text-align: center; vertical-align: top">
                    ...
                    <asp:Panel runat="server" ID="Panel3" Visible='<%#AccessEdit(Convert.ToInt32(Eval("GroupMediaID"))) %>'>
                        <asp:ImageButton ID="ibtnEdit" runat="server" ImageUrl='<%# EditLinkImageUrl %>'
                            CommandName="EditItem" CommandArgument='<%# Eval("ItemID") %>'
                            CausesValidation="false" />
                    </asp:Panel>
                    <asp:Panel runat="server" ID="Panel2" Visible='<%#AccessDelete(Convert.ToInt32(Eval("GroupMediaID"))) %>'>
