...
<asp:Panel ID="pnlTab1" runat="server" ViewStateMode="Disabled" EnableViewState="false">
    <div class="video contentCol_Right_common"> 
        <h2><img src="../Data/Images/bdbnd/gihan_camera.png" />
            <asp:HyperLink ID="hpllCategory" runat="server" ViewStateMode="Disabled" EnableViewState="false"></asp:HyperLink>
        </h2>
        <div class="video_ct">
            <asp:Image ID="imgNew" runat="server" ViewStateMode="Disabled" EnableViewState="false" />
            <h3><asp:HyperLink ID="hplMedia" runat="server" ViewStateMode="Disabled" EnableViewState="false"></asp:HyperLink></h3>
        </div>
    </div>
</asp:Panel> 
