<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="ViewListMediaAlbum.aspx.cs" Inherits="MediaFeature.UI.ViewListMediaAlbum" %>

<%@ Register Namespace="mojoPortal.Web.ForumUI" Assembly="mojoPortal.Features.UI" TagPrefix="forum" %>
<%@ Register Src="~/Media/Controls/SlideAlbumList.ascx" TagPrefix="portal" TagName="SlideAlbumList" %>
