...
namespace mojoPortal.Web.UI.Pages
{
    ...
    public partial class SystemLog : NonCmsBasePage
    {
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                literIframe.Text = "<iframe src='/SystemLogArea/SystemLog/Index' height='500' width='100%' title='Hoạt động thành viên'></iframe>";
            }
        }
