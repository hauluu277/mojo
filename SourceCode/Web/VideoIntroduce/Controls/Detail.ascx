...
<style type="text/css">
    ...
    .videoDetail:nth-child(2n+1){
        padding-right:10px;
    }
        .videoDetail:nth-child(2n+2) {
            padding-left:10px;
        }
...
<div class="videolistwrraper">
    <asp:Panel ID="pnlListVideo" runat="server" CssClass="videolist">
        <div class="videoInfo videoInfo_anh">

            <div class="videoContent videoContent_anh">
                <%--<div id="player" class="flowplayer" data-swf="../../Data/FlowPlayer/flowplayer.commercial-6.0.5/flowplayer.swf" data-key="$863732616083910" data-ratio="0.4167"></div>--%>
            ...
            <div class="han_video_content_ct">
                 <div class="videoInfo-title videoInfo-title_anh">
                      <asp:Label ID="lblTittle" runat="server"></asp:Label>
                     <p style="font-size:14px;font-weight:normal;margin-top:10px;"><i class="fa fa-clock-o"></i> <asp:Label ID="lblDate" runat="server"></asp:Label></p>
                </div>
                <div class="videoInfo-view videoInfo-view_anh" style="display: none">
                    <div class="x-time">
        ...
        <div class="othderVideo othderVideo_anh">
           
            <asp:Panel ID="pnlOrtherVideo" runat="server" Visible="false">

                <div class="othderVideo-title othderVideo-title_anh">
                    Video khác
                </div>
                <div class="listvideo listvideo_anh">
                    <asp:Repeater ID="rptVideo" runat="server">
                        <ItemTemplate>
                            <div class="videoDetail <%# (Container.ItemIndex > 0 && Container.ItemIndex + 1 % 3 == 0)?"fixVideoDetail":string.Empty %>">
                                <div class="itemVideo itemVideo_anh">
                                    <a href='<%# VideoIntroduceUtils.VideoDetailItemUrl(SiteRoot,PageId, ModuleId, int.Parse(Eval("ItemID").ToString()),string.Empty)%>' title='<%#Eval("Title") %>'>
                                        ...
                                        <div class="videoTitle videoTitle_anh">
                                            <%#Eval("Title") %>
                                        </div>
                                    </a>
                                </div>
