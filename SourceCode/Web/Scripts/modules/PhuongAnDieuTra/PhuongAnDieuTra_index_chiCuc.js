                ...
                if (data.IsHetHanGopY == false) {
                    if (data.IsLanhDaoPhong) {
                        ...
                        if (data.PheDuyetPhong != null && data.PheDuyetPhong.ItemID > 0) {
                            ...
                            if (data.PhuongAnDieuTra_ChuyenVien != null && data.PhuongAnDieuTra_ChuyenVien.TrangThai == 1) {
                                result += `<a href="javascript:OpenForm(${data.SiteID},${data.PhuongAnDieuTra_ChuyenVien.ItemID})" class="btn btn-success" data-id="10595" title="Chỉnh sửa"><i class="fa fa-tags fa-lg"></i>  Chỉnh sửa</a>`
                            } else {
