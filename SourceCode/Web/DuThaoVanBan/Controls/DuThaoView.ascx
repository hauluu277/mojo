    ...
    <asp:Panel ID="pncmtdraft" runat="server">
        ...
        <div class="panel panel-default">
            ...
            <asp:RegularExpressionValidator ID="regexUrl" runat="server" ControlToValidate="txtItemUrl"
                ...
                <asp:Panel ID="pnlSuccess" runat="server" CssClass="width100" Visible="false">
                    <p class="alert alert-success">Gửi góp ý kiến thành công. Cảm ơn bạn đã đóng góp ý kiến!</p>
                </asp:Panel>
            </div>
        </div>
    </asp:Panel>
