<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="ManageArticleCTV.aspx.cs" Inherits="ArticleFeature.UI.ManageArticleCTV" %>

<%@ Register Src="~/Article/Controls/ManageArticleCTVControl.ascx" TagPrefix="portal" TagName="ManageArticleCTVControl" %>
        ...
        <portal:mojoPanel ID="mp1" runat="server" ArtisteerCssClass="art-Post" RenderArtisteerBlockContentDivs="true">
            ...
            <asp:Panel ID="pnlWrapper" runat="server" CssClass="art-Post-inner panelwrapper managepost">
                <portal:mojoPanel ID="MojoPanel1" runat="server" ArtisteerCssClass="art-PostContent">
                    <portal:ManageArticleCTVControl runat="server" id="ManageArticleCTVControl" />
                </portal:mojoPanel>
                <div class="cleared">
                </div>
            </asp:Panel>
