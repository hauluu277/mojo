<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="ManagePost.aspx.cs" Inherits="ArticleFeature.UI.ManagePost" %>

<%@ Register TagPrefix="article" TagName="PostList" Src="~/Article/Controls/PostList.ascx" %>
    ...
    <portal:mojoPanel ID="mp1" runat="server" ArtisteerCssClass="art-Post" RenderArtisteerBlockContentDivs="true">
        ...
        <asp:Panel ID="pnlWrapper" runat="server" CssClass="art-Post-inner panelwrapper managepost">
            <portal:mojoPanel ID="MojoPanel1" runat="server" ArtisteerCssClass="art-PostContent">
                <article:PostList ID="articleList" runat="server" />
            </portal:mojoPanel>
            <div class="cleared">
            </div>
        </asp:Panel>
