<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ManageArticleCTVControl.ascx.cs" Inherits="ArticleFeature.UI.ManageArticleCTVControl" %>
...
<asp:Panel ID="pnlSearch" runat="server" DefaultButton="btnSearch">
    <fieldset class="fieldset">
        ...
        <div class="width100 hide hide-item">
        ...
        <div class="search-item hide hide-item">
        ...
        <div class="searchSubmit">
            ...
            &nbsp;&nbsp;
        <button type="button" class="btn btn-primary" onclick="ShowSearch()">Nâng cao</button>
        </div>
    </fieldset>
</asp:Panel>
...
<div id="toolbar-box">
    <div class="tool-btn">
        <portal:mojoButton ID="btnaddnew" runat="server" SkinID="ButtonPrimary" OnClick="btnaddnew_Click" Visible="false" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="float: left; width: 70%;">
                            ...
                            <p>
                                Cổng thành viên: <%#Eval("ClientName") %>
                            </p>
                            <%# Eval("Summary") %>
                    </td>
