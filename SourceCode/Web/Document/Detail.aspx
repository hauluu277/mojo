                    ...
                    <div class="module">
                        <div class="module-table-body">
                            ...
                            <asp:Panel ID="pnOthers" runat="server">
                                ...
                                <table class="table table-striped table-bordered table-hover table-condensed other-doc">
                                    <tbody>
                                        <asp:Repeater ID="rptOthers" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:HyperLink ID="lnkOthers" CssClass="lnk_others" runat="server" NavigateUrl='<%#DocumentUltils.FormatBlogTitleUrl(siteSettings.SiteRoot, Eval("ItemUrl").ToString(), Convert.ToInt32(Eval("ItemID")), pageId, moduleId,true,"/document/detail.aspx?pageid="+pageId+"&item="+Eval("ItemID")+"&mid=9373") %>'><%#formatContent(Eval("Summary").ToString()) %></asp:HyperLink>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
