    ...
    public partial class Register : NonCmsBasePage
	{
        ...
        private void Page_Load(object sender, EventArgs e)
		{
            ...
            if (!IsPostBack)
            {
                BindNewsletterList();
                SetInitialFocus();
                pnlRegister.CssClass = siteSettings.GiaoDienHienThi;
            }
        ...
        void RegisterUser_CreatedUser(object sender, EventArgs e)
        {
            ...
            {
                siteUser = new SiteUser(siteSettings.SiteId, txtEmail.Text);
            }
            else
            {
                siteUser = new SiteUser(siteSettings.SiteId, txtUserName.Text);
            }
