...
//#endif
		...
		protected void Application_End(Object sender, EventArgs e)
		{
			...
			Application.Lock();
			Application["LuotOnline"] = Convert.ToInt32(Application["LuotOnline"]) - 1;
			Application.UnLock();
		...
		protected void Application_BeginRequest(Object sender, EventArgs e)
		{
            ...
            //string filePath = Server.MapPath("ThongKeTruyCap.txt");
            //if (File.Exists(filePath))
            //{
            //	double luotTruyCap = Convert.ToDouble(File.ReadAllText(filePath));
            //	luotTruyCap++;
            //	File.WriteAllText(filePath, luotTruyCap.ToString());
            //	Application["LuotTruyCap"] = luotTruyCap;
            //}
...
//#endif
		...
		protected void Session_Start(Object sender, EventArgs e)
		{
            ...
            //thongKeTruyCapBusiness.AutoAddVisit();
			thongKeTruyCapBusiness.AutoAddVisit();
