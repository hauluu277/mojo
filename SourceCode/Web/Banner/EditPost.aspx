                        ...
                        <div class="panel-body">
                            <ol class="formlist">
                                <li class="settingrow">
                                    ...
                                    <asp:TextBox ID="txtName" CssClass="verywidetextbox forminput" Width="100%" runat="server" />
                                ...
                                <li class="settingrow date">
                                    ...
                                    <mp:jsCalendarDatePicker ID="JsCalendarDatePicker1" Visible="false" runat="server" ShowTime="false" CssClass="datetime-input" />
                                    <asp:CompareValidator
                                ...
                                <li class="settingrow">
                                    ...
                                    <asp:TextBox ID="txtPriority" CssClass="verywidetextbox forminput" runat="server" />
