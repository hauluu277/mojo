...
function UrlHelper(inputText, outputText, referenceText, warningSpan, serviceUrl, category) {
...
UrlHelper.prototype.onchange = function () {
    ...
    if (this.category) {
        this.query = this.inputText.value + "&cat=" + this.category.value;
    } else {
...
UrlHelper.prototype.GetData = function (callback, urlHelper) {
    ...
    xmlhttp.onreadystatechange = function () { http_onreadystatechange(xmlhttp, callback, urlHelper); }
