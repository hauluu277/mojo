...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        //
        HttpCookie reqCookies = Request.Cookies["user_CkfinderPath"];
        return true;
        //
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "Quản lý tập tin";
        LicenseKey = "AL1KST6DL8KPJN6DQ28UDEEWWGEBSKYJ";
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "flac", "alac", "ape","mp3", "aac", "wma", "vorbis" };
        type.DeniedExtensions = new string[] { };
