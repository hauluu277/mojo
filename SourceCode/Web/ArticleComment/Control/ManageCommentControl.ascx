    ...
    <div class="panel-body">
        <div class="form-vertical">
            <div class="form-group col-sm-12">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    <div class="col-sm-6" style="padding: 0; padding-right: 5px; float: left">
                    ...
                    <div class="col-sm-6" style="padding: 0; padding-left: 5px; float: left">
                        <label class="width100">Xuất bản</label>
            ...
            <div class="form-group col-sm-12">
                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <input type="text" class="form-control date width200" style="width: 30%; float: left" name="date" id="txtStartDate" runat="server" />
                    <span style="float: left">&nbsp;-&nbsp;</span>
                    <input type="text" class="form-control date width200" style="width: 30%; float: left" name="date" runat="server" id="txtEndDate" />
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="text-align: center">
                                <asp:ImageButton ID="ibtnStatus" runat="server" ImageUrl='<%# Common.StatusIconComment(Eval("ModerationStatus")) %>'
