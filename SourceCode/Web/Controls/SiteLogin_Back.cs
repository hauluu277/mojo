...
namespace mojoPortal.Web.UI
{
    ...
    public class SiteLogin_Back : Login
    {
        ...
        void SiteLogin_LoggingIn(object sender, LoginCancelEventArgs e)
        {
            ...
            if (siteUser.UserId > -1)
            {
                ...
                if (DestinationPageUrl.Contains(RedirectDieuHanh))
                {
                    //continude
                    HasReturnCode = true;
        ...
        protected void SiteLogin_LoggedIn(object sender, EventArgs e)
        {
            ...
            try
            {
                var getLog = core_LogSystem.GetByUser(siteUser.UserId);
                if (getLog != null)
                {
                ...
                {
                    core_LogSystem coreLogSystem = new core_LogSystem();
