...
<portal:BreadcrumbContainer ID="pnlWrapper" runat="server" EnableViewState="false">
    <portal:SiteMapPath ID="breadCrumbsControl" runat="server" Visible="false" EnableViewState="false">
        <RootNodeTemplate>
            ...
            <asp:HyperLink ID="lnkRoot" runat="server" NavigateUrl='<%# siteRootRedirect %>' Text='<%# rootLinkText %>' CssClass='<%# CssClass %>' EnableViewState="false" />
...
<asp:Panel ID="pnlBrecumOther" runat="server">
    <asp:Literal ID="literBrecumOther" runat="server"></asp:Literal>
</asp:Panel>
