...
namespace mojoPortal.Web.UI
{
    ...
    public class LogoutLink : WebControl
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            if (isMasterPage)
            {
                writer.Write("<li style='padding: 0 10px 0 0' class='li-class'>| </li>");
            }
            
            if (renderAsListItem)
            {
                //writer.Write("<li class='" + listItemCSS + "'>");e
            ...
            var urlToUse = ConfigurationManager.AppSettings["ApiSSO_SignOutSuccess"];
            if (urlToUse.Contains("signoutsuccess")==false)
            {
