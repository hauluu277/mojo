...
namespace mojoPortal.Web.UI
{
    ...
    //Page.ClientScript.GetPostBackEventReference(btnPostComment, string.Empty)
    //);
        ...
        private void btnPostComment_Click(object sender, EventArgs e)
        {
            ...
            comment.FTS = comment.UserName.ConvertToFTS() + " " + comment.UserEmail + " " + comment.UserComment.ConvertToFTS();
            ...
            string script = "alert('Cảm ơn bạn đã đóng góp ý kiến!');";
            ScriptManager.RegisterStartupScript(pnlUpdate, this.GetType(), "commentsuccess", script, true);
        ...
        private void LoadSetings()
        {
            ...
            reqEmail.ErrorMessage = "Địa chỉ email không hợp lệ";
