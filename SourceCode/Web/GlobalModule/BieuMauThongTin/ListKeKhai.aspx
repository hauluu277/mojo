<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master" CodeBehind="ListKeKhai.aspx.cs" Inherits="BieuMauThongTinFeatures.UI.ListKeKhai" %>
...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    ...
    <script>
        $(document).ready(function () {
            CallAjaxLoading("get", "/BieuMauThongTinArea/BieuMauThongTin/IndexNopBieuMauThongTin", null, true, function (rs) {
