...
// Pass this if window is not defined yet
    ...
    Pagination.defaults = {
        ...
        PAGES: '<li class="' + CLS_PAGE + ' ' + CLS_PAGES + ' ' + CLS_FIRST + '"><span class=""><em class="' + CLS_INDEX + '">{current}</em> / <strong class="total">{total}</strong> Trang</span></li>',
        PREV: '<li class="' + CLS_PAGE + ' ' + CLS_PREV + '"><a class="">{prev}</a></li>',
        NEXT: '<li class="' + CLS_PAGE + ' ' + CLS_NEXT + ' ' + CLS_LAST + '"><a class="">{next}</a></li>',
        PAGE: '<li class="' + CLS_PAGE + ' ' + CLS_NAV + '" title="{page}"><a class="">{page}</a></li>',
        FIRST: '<li class="' + CLS_PAGE + ' ' + CLS_NAV + '" title="1"><a class="">1</a></li>',
        LAST: '<li class="' + CLS_PAGE + ' ' + CLS_NAV + '" title="{total}"><a class="">{total}</a></li>',
        ELLIPSIS: '<li class="' + CLS_PAGE + ' ' + CLS_ELLIPSIS + '"><span class="">{ellipsis}</span></li>',
        CURRENT: '<li class="' + CLS_PAGE + ' ' + CLS_NAV + ' ' + CLS_CURRENT + '"><span class="">{page}</span></li>'
    };
