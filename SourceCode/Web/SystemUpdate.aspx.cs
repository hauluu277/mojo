...
namespace mojoPortal.Web
{
    ...
    public partial class SystemUpdate : mojoBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                litErrorMessage.Text = "Rất tiếc, chúng tôi không thể tìm thấy trang bạn đang tìm kiếm. Vui lòng liên hệ người quản trị để biết thêm thông tin.";
            }
