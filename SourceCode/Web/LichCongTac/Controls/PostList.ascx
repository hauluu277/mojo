...
<div id="toolbar-box">
    <div class="tool-btn">
        ...
        <portal:mojoButton ID="btnExport" Text="Thống kê" runat="server" />
                    ...
                    <ContentTemplate>
                        <div class="col-sm-12 col-md-6">
                            <div class="search-control">
                                <mp:SiteLabel ID="lblYear" runat="server" ForControl="ddlYear" CssClass="search-label1 col-sm-4"
                                    ConfigKey="YearHeaderLabel" ResourceFile="LichCongTacResources"></mp:SiteLabel>
                                <div class="col-sm-8">
                                    <asp:DropDownList ID="ddlYear" runat="server" AutoPostBack="true" CssClass="ddlSettingLabel1"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="search-control">
                                <mp:SiteLabel ID="lblWeek" runat="server" ForControl="ddlWeek" CssClass="search-label1 col-sm-4"
                                    ConfigKey="WeekHeaderLabel" ResourceFile="LichCongTacResources"></mp:SiteLabel>
                                <div class="col-sm-8">
                                    <asp:DropDownList ID="ddlWeek" runat="server" CssClass="ddlSettingLabel1"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                    </ContentTemplate>
            ...
            <div class="form-group">
                <div class="col-sm-12 col-md-6">
                    <div class="search-control">
                        ...
                        <label class="search-label1 col-sm-4">Lãnh đạo tham gia</label>
                        <div class="col-sm-8">
                            <asp:DropDownList ID="ddlCategoryAuthor" runat="server"></asp:DropDownList>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="search-control">
                        <mp:SiteLabel ID="lblKeyword" runat="server" ForControl="txtKeyword" CssClass="search-label1 col-sm-4"
            ...
            <HeaderTemplate>
                <table class="tablesorter" id="myTable">
                    <tr>
                        ...
                        <th style="width: 65%" class="tbl-header">Nội dung
                        </th>
