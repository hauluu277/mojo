...
{
    public static class UtilCacheHelper
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(UtilCacheHelper));
        ...
        public static List<TimeZoneInfo> GetTimeZones()
        {
            ...
            {
                lock (typeof(UtilCacheHelper))
                {
                    if (HttpRuntime.Cache[cacheKey] != null)
                    {
                        return HttpRuntime.Cache[cacheKey] as List<TimeZoneInfo>;
                    }
                    ...
                    List<TimeZoneInfo> timeZones = DateTimeHelper.GetTimeZoneList();
        ...
        public static void RedirectToSignOut()
        {
            ...
            HttpContext.Current.Response.Redirect("/Logoff.aspx", true);
