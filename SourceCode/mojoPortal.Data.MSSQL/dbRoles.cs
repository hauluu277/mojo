...
namespace mojoPortal.Data
{
    ...
    public static class DBRoles
    {
        ...
        public static IDataReader GetRolesUser(
        int userId)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Roles_SelectRolesUser", 1);
            sph.DefineSqlParameter("@UserID", SqlDbType.Int, ParameterDirection.Input, userId);
            return sph.ExecuteReader();
        }
