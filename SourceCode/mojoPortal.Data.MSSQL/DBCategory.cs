...
namespace mojoPortal.Data
{
    ...
    public static class DBCategory
    {
        ...
        public static IDataReader GetAllCategory(string listCatagory, DateTime? startDate, DateTime? endDate, int siteId)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Sites_SelectStaticArticleCatagory", 4);
            sph.DefineSqlParameter("@ListCatagory", SqlDbType.NVarChar, 500, ParameterDirection.Input, listCatagory);
        ...
        public static IDataReader GetAllCatagoryBySite(int SiteId)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Sites_SelectAllCatagory", 1);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, SiteId);
            return sph.ExecuteReader();
        }
        /// <summary>
