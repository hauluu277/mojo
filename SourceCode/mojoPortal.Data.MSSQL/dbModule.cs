...
namespace mojoPortal.Data
{
    ...
    public static class DBModule
    {
        ...
        public static int AddModuleForSkinPageModule(
            int skinPageModule,
          int siteId,
          Guid siteGuid,
          int moduleDefId,
          ...
          int publishMode)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Modules_InsertForSkinPageModule", 22); //JOE DAVIS
            sph.DefineSqlParameter("@SkinPageModule", SqlDbType.Int, ParameterDirection.Input, skinPageModule);
        ...
        public static IDataReader GetDefaultModule(int itemId)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_DefaultModules_SelectOne", 1);
            sph.DefineSqlParameter("@ItemID", SqlDbType.Int, ParameterDirection.Input, itemId);
            return sph.ExecuteReader();
        }
        public static IDataReader GetDefaultModuleInPage4Site(int siteId)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_Default_ForSite", 1);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            return sph.ExecuteReader();
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_DefaultModules_Delete", 1);
            sph.DefineSqlParameter("@ItemID", SqlDbType.Int, ParameterDirection.Input, itemId);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > -1);
        }
        ...
        public static IDataReader GetModuleForSkinPageModule(int skinPageModule)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_SelectOneForSkinPageModule", 1);
            sph.DefineSqlParameter("@SkinPageModule", SqlDbType.Int, ParameterDirection.Input, skinPageModule);
            return sph.ExecuteReader();
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_GetByPage", 1);
            sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
            return sph.ExecuteReader();
        }
        ...
        public static int AddDefaultModule(int siteId, int moduleId, string moduleTitle, string paneName, int moduleOrder)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_DefaultModulePage_Insert", 5); //namdv
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
            sph.DefineSqlParameter("@ModuleOrder", SqlDbType.Int, ParameterDirection.Input, moduleOrder);
            sph.DefineSqlParameter("@PaneName", SqlDbType.NVarChar, 50, ParameterDirection.Input, paneName);
        ...
        public static bool UpdateDefaultModule(
            int itemId,
            int siteId,
            int moduleId,
            string moduleTitle,
            ...
            int moduleOrder)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_DefaultModulePage_Update", 6);
            sph.DefineSqlParameter("@ItemID", SqlDbType.Int, ParameterDirection.Input, itemId);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
            sph.DefineSqlParameter("@ModuleTitle", SqlDbType.NVarChar, ParameterDirection.Input, moduleTitle);
            sph.DefineSqlParameter("@PaneName", SqlDbType.NVarChar, ParameterDirection.Input, paneName);
            sph.DefineSqlParameter("@ModuleOrder", SqlDbType.Int, ParameterDirection.Input, moduleOrder);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > -1);
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_DefaultModules_UpdateModuleOrder", 3);
            sph.DefineSqlParameter("@ItemID", SqlDbType.Int, ParameterDirection.Input, itemId);
            sph.DefineSqlParameter("@ModuleOrder", SqlDbType.Int, ParameterDirection.Input, moduleOrder);
            sph.DefineSqlParameter("@PaneName", SqlDbType.NVarChar, 50, ParameterDirection.Input, paneName);
            int rowsAffected = sph.ExecuteNonQuery();
