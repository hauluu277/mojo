...
namespace mojoPortal.Data
{
    ...
    public static class DBGeoZone
    {
        ...
        public static int Create(
            ...
            int orderBy)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_GeoZone_Insert", 6);
            ...
            sph.DefineSqlParameter("@Is_Weather", SqlDbType.Bit, ParameterDirection.Input, is_Weather);
        ...
        public static bool Update(
            ...
            int orderBy)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_GeoZone_Update", 6);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            sph.DefineSqlParameter("@CountryGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, countryGuid);
            sph.DefineSqlParameter("@Name", SqlDbType.NVarChar, 255, ParameterDirection.Input, name);
            sph.DefineSqlParameter("@Code", SqlDbType.NVarChar, 255, ParameterDirection.Input, code);
        ...
        public static IDataReader GetByCode2(string code)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_GeoZone_SelectByCode2", 1);
            sph.DefineSqlParameter("@Code", SqlDbType.VarChar, 255, ParameterDirection.Input, code);
            return sph.ExecuteReader();
