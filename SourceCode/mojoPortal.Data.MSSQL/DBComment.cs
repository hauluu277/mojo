...
namespace mojoPortal.Data
{
    ...
    public static class DBComments
    {
        ...
        public static int Create(
            ...
            string fts)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Comments_Insert", 18);
        ...
        public static bool Update(
            ...
            string fts)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Comments_Update", 13);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            sph.DefineSqlParameter("@UserGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, userGuid);
            sph.DefineSqlParameter("@Title", SqlDbType.NVarChar, 255, ParameterDirection.Input, title);
            sph.DefineSqlParameter("@UserComment", SqlDbType.NVarChar, -1, ParameterDirection.Input, userComment);
        ...
        /// </summary>
        /// <param name="guid"> guid </param>
        public static IDataReader GetByContentDesc(Guid contentGuid, bool isAdmin)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Comments_SelectByContentDesc", 2);
            sph.DefineSqlParameter("@ContentGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, contentGuid);
        ...
        public static IDataReader GetSelectPage(Guid siteGuid, Guid featureGuid, int published, int puApprove, int categoryID, Guid articleGuid, int moderationStatus, DateTime? dateStart, DateTime? dateEnd, string keyword, int pageNumber, int pageSize, out int totalPages, out int totalCounts)
        {
            totalPages = 1;
            int totalRows
                = GetSelectCount(siteGuid, featureGuid, published, puApprove, categoryID, articleGuid, moderationStatus, dateStart, dateEnd, keyword);
            ...
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Comments_SelectPage", 12);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            sph.DefineSqlParameter("@FeatureGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, featureGuid);
            sph.DefineSqlParameter("@IsPublished", SqlDbType.Int, ParameterDirection.Input, published);
            sph.DefineSqlParameter("@IsApprove", SqlDbType.Int, ParameterDirection.Input, puApprove);
            ...
            sph.DefineSqlParameter("@ModerationStatus", SqlDbType.Int, ParameterDirection.Input, moderationStatus);
            sph.DefineSqlParameter("@DateStart", SqlDbType.DateTime, ParameterDirection.Input, dateStart);
            sph.DefineSqlParameter("@DateEnd", SqlDbType.DateTime, ParameterDirection.Input, dateEnd);
            sph.DefineSqlParameter("@Keyword", SqlDbType.NVarChar, 255, ParameterDirection.Input, keyword);
            sph.DefineSqlParameter("@PageNumber", SqlDbType.Int, ParameterDirection.Input, pageNumber);
            sph.DefineSqlParameter("@PageSize", SqlDbType.Int, ParameterDirection.Input, pageSize);
            return sph.ExecuteReader();
        }
        public static int GetSelectCount(Guid siteGuid, Guid featureGuid, int published, int approve, int categoryID, Guid articleGuid, int moderationStatus, DateTime? dateStart, DateTime? dateEnd, string keyword)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Comments_GetCount", 10);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            sph.DefineSqlParameter("@FeatureGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, featureGuid);
            sph.DefineSqlParameter("@IsPublished", SqlDbType.Int, ParameterDirection.Input, published);
            sph.DefineSqlParameter("@IsApprove", SqlDbType.Int, ParameterDirection.Input, approve);
            sph.DefineSqlParameter("@CategoryID", SqlDbType.Int, ParameterDirection.Input, categoryID);
            sph.DefineSqlParameter("@ArticleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, articleGuid);
            sph.DefineSqlParameter("@ModerationStatus", SqlDbType.Int, ParameterDirection.Input, moderationStatus);
            sph.DefineSqlParameter("@DateStart", SqlDbType.DateTime, ParameterDirection.Input, dateStart);
