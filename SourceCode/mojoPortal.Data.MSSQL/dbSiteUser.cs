...
namespace mojoPortal.Data
{
    public static class DBSiteUser
    {
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectUserByLoginName", 2);
        ...
        public static IDataReader GetUserByRoleName(int siteId, string roleName)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectUserByRole", 2);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            sph.DefineSqlParameter("@RoleName", SqlDbType.NVarChar, 255, ParameterDirection.Input, roleName);
            return sph.ExecuteReader();
        }

        public static IDataReader GetByRoleName(int siteId, string roleName)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectByRole", 2);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            sph.DefineSqlParameter("@RoleName", SqlDbType.NVarChar, 255, ParameterDirection.Input, roleName);
            return sph.ExecuteReader();
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_CountByFirstLetter", 3);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            sph.DefineSqlParameter("@SiteManager", SqlDbType.Int, ParameterDirection.Input, siteManager);
        ...
        public static int UserCountSync(int siteSync, String userNameBeginsWith)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_CountByFirstLetterSync", 2);
            sph.DefineSqlParameter("@SiteSync", SqlDbType.Int, ParameterDirection.Input, siteSync);
            sph.DefineSqlParameter("@UserNameBeginsWith", SqlDbType.NVarChar, 1, ParameterDirection.Input, userNameBeginsWith);
        ...
        public static IDataReader GetUserListPageSync(
          int siteSync,
          int pageNumber,
          int pageSize,
        ...
        {
            totalPages = 1;
            int totalRows = UserCountSync(siteSync, userNameBeginsWith);
            ...
            {
                case 1:
                    sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectPageByDateDescSync", 4);
                    break;

                case 2:
                    sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectPageSortLFSync", 4);
                    break;

                case 0:
                default:
                    sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectPageSync", 4);
                    break;
            }
        ...
        {
            totalPages = 1;
            int totalRows = UserCount(siteId, siteManager, userNameBeginsWith);
            ...
            {
                case 1:
                    sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectPageByDateDesc", 5);
                    break;

                case 2:
                    sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectPageSortLF", 5);
                    break;
        ...
        private static int CountForSearchSync(int siteSync, string searchInput)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_CountForSearchSync", 2);
            sph.DefineSqlParameter("@SiteSync", SqlDbType.Int, ParameterDirection.Input, siteSync);
            sph.DefineSqlParameter("@SearchInput", SqlDbType.NVarChar, 50, ParameterDirection.Input, searchInput);
            int count = Convert.ToInt32(sph.ExecuteScalar());
            return count;
        ...
        public static IDataReader GetUserSearchPageSync(
          int siteSync,
          int pageNumber,
          int pageSize,
          string searchInput,
        ...
        {
            totalPages = 1;
            int totalRows = CountForSearchSync(siteSync, searchInput);
            ...
            {
                case 1:
                    sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectSearchPageByDateDescSync", 4);
                    break;

                case 2:
                    sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectSearchPageByLFSync", 4);
                    break;

                case 0:
                default:
                    sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectSearchPageSync", 4);
                    break;
            }
        ...
        private static int CountForAdminSearch(int siteId, int siteManager, string searchInput)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_CountForAdminSearch", 3);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            sph.DefineSqlParameter("@SiteManager", SqlDbType.Int, ParameterDirection.Input, siteManager);
            sph.DefineSqlParameter("@SearchInput", SqlDbType.NVarChar, 50, ParameterDirection.Input, searchInput);
            int count = Convert.ToInt32(sph.ExecuteScalar());
        ...
        private static int CountForAdminSearchSync(int siteSync, string searchInput)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_CountForAdminSearchSync", 2);
            sph.DefineSqlParameter("@SiteSync", SqlDbType.Int, ParameterDirection.Input, siteSync);
            sph.DefineSqlParameter("@SearchInput", SqlDbType.NVarChar, 50, ParameterDirection.Input, searchInput);
            int count = Convert.ToInt32(sph.ExecuteScalar());
            return count;
        ...
        public static IDataReader GetUserAdminSearchPageSync(
          int siteSync,
          int pageNumber,
          int pageSize,
          string searchInput,
        ...
        {
            totalPages = 1;
            int totalRows = CountForAdminSearchSync(siteSync, searchInput);
            ...
            {
                case 1:
                    sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectAdminSearchPageByDateDescSync", 4);
                    break;

                case 2:
                    sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectAdminSearchPageByLFSync", 4);
                    break;

                case 0:
                default:
                    sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectAdminSearchPageSync", 4);
                    break;
            }
        ...
        {
            totalPages = 1;
            int totalRows = CountForAdminSearch(siteId, siteManager, searchInput);
            ...
            {
                case 1:
                    sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectAdminSearchPageByDateDesc", 5);
                    break;

                case 2:
                    sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectAdminSearchPageByLF", 5);
                    break;

                case 0:
                default:
                    sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectAdminSearchPage", 5);
                    break;
            }
        ...
        public static int CountLockedOutUsersSync(int siteSync)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_CountLockedSync", 1);
            sph.DefineSqlParameter("@SiteSync", SqlDbType.Int, ParameterDirection.Input, siteSync);
        ...
        public static IDataReader GetPageLockedUsersSync(
          int siteSync,
          int pageNumber,
          int pageSize,
          out int totalPages)
        {
            totalPages = 1;
            int totalRows = CountLockedOutUsersSync(siteSync);
            ...
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectLockedPageSync", 3);
            sph.DefineSqlParameter("@SiteSync", SqlDbType.Int, ParameterDirection.Input, siteSync);
            sph.DefineSqlParameter("@PageNumber", SqlDbType.Int, ParameterDirection.Input, pageNumber);
            sph.DefineSqlParameter("@PageSize", SqlDbType.Int, ParameterDirection.Input, pageSize);
            return sph.ExecuteReader();
        ...
        public static int CountNotApprovedUsersSync(int siteAsync)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_CountNotApprovedSync", 1);
            sph.DefineSqlParameter("@SiteAsync", SqlDbType.Int, ParameterDirection.Input, siteAsync);

            int count = Convert.ToInt32(sph.ExecuteScalar());
            return count;
        }
        public static IDataReader GetPageNotApprovedUsersSync(
           int siteAsync,
           int pageNumber,
           int pageSize,
           out int totalPages)
        {
            totalPages = 1;
            int totalRows = CountNotApprovedUsersSync(siteAsync);
            ...
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectNotApprovedPageSync", 3);
            sph.DefineSqlParameter("@SiteAsync", SqlDbType.Int, ParameterDirection.Input, siteAsync);
            sph.DefineSqlParameter("@PageNumber", SqlDbType.Int, ParameterDirection.Input, pageNumber);
            sph.DefineSqlParameter("@PageSize", SqlDbType.Int, ParameterDirection.Input, pageSize);
            return sph.ExecuteReader();
        ...
        public static IDataReader GetAllUser(int SiteId)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Sites_SelectAllUser", 1);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, SiteId);
            return sph.ExecuteReader();
        }
        public static IDataReader GetStaticArticleUser(string listUser, DateTime? startDate, DateTime? endDate)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Sites_SelectStaticArticleUser", 3);
            sph.DefineSqlParameter("@ListUser", SqlDbType.NVarChar, 500, ParameterDirection.Input, listUser);
        ...
        public static int AddUser(
            ...
            int siteSync,
            string AD_MCS,
            string AD_TenDonViCS,
            string AD_PhongBan,
            string AD_TenPhongBan,
            int? departmentId,
            string siteManager
            )
        {

            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Users_Insert", 30);
            ...
            sph.DefineSqlParameter("@AD_MCS", SqlDbType.NVarChar, 50, ParameterDirection.Input, AD_MCS);
            sph.DefineSqlParameter("@AD_TenDonViCS", SqlDbType.NVarChar, 350, ParameterDirection.Input, AD_TenDonViCS);
            sph.DefineSqlParameter("@AD_PhongBan", SqlDbType.NVarChar, 50, ParameterDirection.Input, AD_PhongBan);
            sph.DefineSqlParameter("@AD_TenPhongBan", SqlDbType.NVarChar, 350, ParameterDirection.Input, AD_TenPhongBan);
            sph.DefineSqlParameter("@DepartmentId", SqlDbType.Int, ParameterDirection.Input, departmentId);
            sph.DefineSqlParameter("@SiteManager", SqlDbType.NVarChar, -1, ParameterDirection.Input, siteManager);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Users_Update", 56);
        ...
        public static IDataReader GetSingleUserCustom(int siteId, string email, int siteLogin)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectByEmailCustom", 3);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            sph.DefineSqlParameter("@Email", SqlDbType.NVarChar, 100, ParameterDirection.Input, email);
            sph.DefineSqlParameter("@SiteLogin", SqlDbType.Int, ParameterDirection.Input, siteLogin);
            return sph.ExecuteReader();
        }

        public static IDataReader GetSingleUser(int siteId, string email, int siteLogin)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectByEmail", 3);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            sph.DefineSqlParameter("@Email", SqlDbType.NVarChar, 100, ParameterDirection.Input, email);
            sph.DefineSqlParameter("@SiteLogin", SqlDbType.Int, ParameterDirection.Input, siteLogin);
            return sph.ExecuteReader();
        ...
        public static IDataReader GetSingleUserByLoginNameCustom(int siteId, string loginName, bool allowEmailFallback, int siteLogin)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectByLoginNameCustom", 4);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            sph.DefineSqlParameter("@LoginName", SqlDbType.NVarChar, 50, ParameterDirection.Input, loginName);
        ...
        public static IDataReader GetSingleUserByLoginName(int siteId, string loginName, bool allowEmailFallback, int siteLogin)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Users_SelectByLoginName", 4);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            sph.DefineSqlParameter("@LoginName", SqlDbType.NVarChar, 50, ParameterDirection.Input, loginName);
            sph.DefineSqlParameter("@AllowEmailFallback", SqlDbType.Bit, ParameterDirection.Input, allowEmailFallback);
            sph.DefineSqlParameter("@SiteLogin", SqlDbType.Int, ParameterDirection.Input, siteLogin);
