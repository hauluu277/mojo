...
namespace mojoPortal.Data
{
    ...
    public static class DBPageSettings
    {
        ...
        public static int Create(
            ...
            string pageNameEN,
            bool is_Request_Login)
        {

            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Pages_Insert", 63); 
            ...
            sph.DefineSqlParameter("@CategoryConfig", SqlDbType.NVarChar, 255, ParameterDirection.Input, categoryConfig);
            sph.DefineSqlParameter("@PageNameEN", SqlDbType.NVarChar, 255, ParameterDirection.Input, pageNameEN);
            sph.DefineSqlParameter("@Is_Request_Login", SqlDbType.Bit, ParameterDirection.Input, is_Request_Login);
        ...
        public static bool UpdatePage(
            ...
            bool is_Request_Login)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Pages_Update", 61);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_SiteSettings_GetRoot", 1);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            return sph.ExecuteReader();
        }
        ...
        public static IDataReader GetListParent(int siteId)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Pages_GetPageListParent", 1);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            return sph.ExecuteReader();
        }


        public static IDataReader GetListChild(int parentID)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Pages_GetPageListChild", 1);
            sph.DefineSqlParameter("@ParentID", SqlDbType.Int, ParameterDirection.Input, parentID);
            return sph.ExecuteReader();
        }
        ...
        public static IDataReader GetPageListParent(int siteId, int pageId)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Pages_SelectPageListParent", 2);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
            return sph.ExecuteReader();
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Pages_SelectByCategory", 1);
            sph.DefineSqlParameter("@CategoryID", SqlDbType.VarChar, 50, ParameterDirection.Input, categoryId);
            return Convert.ToInt32(sph.ExecuteScalar());
        }
