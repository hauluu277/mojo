...
namespace mojoPortal.Data
{
    ...
    public static class DBHomeCategoryBuilder
    {
    ...
    int moduleID)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "md_HomeCategory_SelectByModule", 1);
            sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleID);
            return sph.ExecuteReader();
