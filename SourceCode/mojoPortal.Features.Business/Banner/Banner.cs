...
namespace mojoPortal.Business
{
    ...
    public class Banner
    {
        ...
        private void GetBanner(
            int itemID)
        {
            using (IDataReader reader = DBBanner.GetOne(
                itemID))
            {
        ...
        public static bool Delete(
            int itemID)
        {
            return DBBanner.Delete(
                itemID);
        }
        public static bool ChangeIsPublic(
    int itemID)
        {
            return DBBanner.ChangeIsPublic(
                itemID);
        }

        /// <summary>
        /// Gets a count of Banner. 
        /// </summary>
        public static int GetCount(int siteId, int moduleId, bool? status, string keyword)
        {
            return DBBanner.GetCount(siteId, moduleId, status, keyword);
        }

        private static List<Banner> LoadListFromReader(IDataReader reader)
        {
            ...
            try
            {
                while (reader.Read())
                {
                    ...
                    if (!string.IsNullOrEmpty(reader["Priority"].ToString()))
                    {
                        Banner.priority = Convert.ToInt32(reader["Priority"]);
                    }
        ...
        {
            IDataReader reader = DBBanner.GetAll();
            return LoadListFromReader(reader);

        }
        public static List<Banner> GetBannerByConfig(int siteId, int moduleId, int pageId, int number)
        {
            IDataReader reader = DBBanner.GetBannerByConfig(siteId, moduleId, pageId, number);
            return LoadListFromReader(reader);

        }

        /// <summary>
        /// Gets an IList with page of instances of Banner.
        /// </summary>
        /// <param name="pageNumber">The page number.</param>
        /// <param name="pageSize">Size of the page.</param>
        /// <param name="totalPages">total pages</param>
        public static List<Banner> GetPage(int siteId, int moduleId, int pageNumber, int pageSize, bool? status, string keyword, out int totalPages)
        {
            totalPages = 1;
            IDataReader reader = DBBanner.GetPage(siteId, moduleId, pageNumber, pageSize, status, keyword, out totalPages);
            return LoadListFromReader(reader);
        }

        public static List<Banner> GetByModule(int moduleID)
        {
            IDataReader reader = DBBanner.GetByModule(moduleID);
            return LoadListFromReader(reader);
        }
        ...
        /// </summary>
        public static int CompareByItemID(Banner Banner1, Banner Banner2)
        {
        ...
        /// Compares 2 instances of Banner.
        /// </summary>
        public static int CompareByModuleID(Banner Banner1, Banner Banner2)
        {
        ...
        /// Compares 2 instances of Banner.
        /// </summary>
        public static int CompareBySiteID(Banner Banner1, Banner Banner2)
        {
        ...
        /// Compares 2 instances of Banner.
        /// </summary>
        public static int CompareByPageID(Banner Banner1, Banner Banner2)
        {
        ...
        /// Compares 2 instances of Banner.
        /// </summary>
        public static int CompareByName(Banner Banner1, Banner Banner2)
        {
        ...
        /// Compares 2 instances of Banner.
        /// </summary>
        public static int CompareByDescription(Banner Banner1, Banner Banner2)
        {
        ...
        /// Compares 2 instances of Banner.
        /// </summary>
        public static int CompareByLink(Banner Banner1, Banner Banner2)
        {
        ...
        /// Compares 2 instances of Banner.
        /// </summary>
        public static int CompareByPath(Banner Banner1, Banner Banner2)
        {
        ...
        /// Compares 2 instances of Banner.
        /// </summary>
        public static int CompareByHitCount(Banner Banner1, Banner Banner2)
        {
        ...
        /// Compares 2 instances of Banner.
        /// </summary>
        public static int CompareByWidth(Banner Banner1, Banner Banner2)
        {
        ...
        /// Compares 2 instances of Banner.
        /// </summary>
        public static int CompareByNumber(Banner Banner1, Banner Banner2)
        {
        ...
        /// Compares 2 instances of Banner.
        /// </summary>
        public static int CompareByStartDate(Banner Banner1, Banner Banner2)
        {
        ...
        /// Compares 2 instances of Banner.
        /// </summary>
        public static int CompareByCreatedByUser(Banner Banner1, Banner Banner2)
        {
        ...
        /// Compares 2 instances of Banner.
        /// </summary>
        public static int CompareByCreatedDate(Banner Banner1, Banner Banner2)
        {
