...
namespace DictionaryFeature.Business
{
    ...
    public class Dictionary
    {
        ...
        private void GetLookup(
            int itemID)
        {
            using (IDataReader reader = DBDictionary.GetOne(
                itemID))
            {
        ...
        public static List<Dictionary> GetAllPublic()
        {
            IDataReader reader = DBDictionary.GetAllPublic();
        ...
        public static int GetCount(int siteId,
            ...
            string alphabe)
        {
            return DBDictionary.GetCount(siteId,
            isApprove,
            keyword,
            alphabe);
        }

        private static List<Dictionary> LoadListFromReader(IDataReader reader)
        {
            List<Dictionary> lookupList = new List<Dictionary>();
            try
            {
                while (reader.Read())
                {
        ...
        private static List<Dictionary> LoadListFromReader2(IDataReader reader)
        {
            List<Dictionary> lookupList = new List<Dictionary>();
            try
            {
        ...
        {
            IDataReader reader = DBDictionary.GetAll();
            return LoadListFromReader(reader);

        }

        public static List<Dictionary> GetOne(int itemId)
        {
            IDataReader reader = DBDictionary.GetOne(itemId);
            return LoadListFromReader(reader);
        }
        ...
        public static List<Dictionary> GetPage(int siteID, int pageNumber, int pageSize, bool? isApprove, string keyword, string alphabet, out int totalPages)
        {
            totalPages = 1;
            IDataReader reader = DBDictionary.GetPage(siteID, pageNumber, pageSize, isApprove, keyword, alphabet, out totalPages);
            return LoadListFromReader2(reader);
        }

        public static List<Dictionary> GetMany(string keyword, string alphabet)
        {
            IDataReader reader = DBDictionary.GetMany(keyword, alphabet);
            return LoadListFromReader(reader);
        }
        ...
        /// </summary>
        public static int CompareByItemID(Dictionary lookup1, Dictionary lookup2)
        {
        ...
        /// Compares 2 instances of Lookup.
        /// </summary>
        public static int CompareByModuleID(Dictionary lookup1, Dictionary lookup2)
        {
        ...
        /// Compares 2 instances of Lookup.
        /// </summary>
        public static int CompareBySiteID(Dictionary lookup1, Dictionary lookup2)
        {
        ...
        /// Compares 2 instances of Lookup.
        /// </summary>
        public static int CompareByName(Dictionary lookup1, Dictionary lookup2)
        {
        ...
        /// Compares 2 instances of Lookup.
        /// </summary>
        public static int CompareByDescription(Dictionary lookup1, Dictionary lookup2)
        {
        ...
        /// Compares 2 instances of Lookup.
        /// </summary>
        public static int CompareByInterpretation(Dictionary lookup1, Dictionary lookup2)
        {
        ...
        /// Compares 2 instances of Lookup.
        /// </summary>
        public static int CompareByUserCreate(Dictionary lookup1, Dictionary lookup2)
        {
        ...
        /// Compares 2 instances of Lookup.
        /// </summary>
        public static int CompareByDateCreate(Dictionary lookup1, Dictionary lookup2)
        {
        ...
        /// Compares 2 instances of Lookup.
        /// </summary>
        public static int CompareByUserApprove(Dictionary lookup1, Dictionary lookup2)
        {
        ...
        /// Compares 2 instances of Lookup.
        /// </summary>
        public static int CompareByDateApprove(Dictionary lookup1, Dictionary lookup2)
        {
        ...
        /// Compares 2 instances of Lookup.
        /// </summary>
        public static int CompareByItemUrl(Dictionary lookup1, Dictionary lookup2)
        {
        ...
        /// Compares 2 instances of Lookup.
        /// </summary>
        public static int CompareByPageID(Dictionary lookup1, Dictionary lookup2)
        {
