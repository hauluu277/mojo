...
namespace mojoPortal.Business
{
    ...
    public class ContactFormMessage
    {
        ...
        private DateTime? thoiGianPhanHoi;
        ...
        public DateTime? ThoiGianPhanHoi
        {
            get { return thoiGianPhanHoi; }
            set { thoiGianPhanHoi = value; }
        }
        #endregion
        ...
        private void PopulateFromReader(IDataReader reader)
        {
            if (reader.Read())
            {
                ...
                this.trangThai = int.Parse(reader["TrangThai"].ToString());
                this.thoiGianPhanHoi = Convert.ToDateTime(reader["ThoiGianPhanHoi"]);
            }
        ...
        {
            return DBContactFormMessage.GetCount(name, email, moduleGuid);
        }
        ...
        private static List<ContactFormMessage> LoadListFromReader(IDataReader reader)
        {
            ...
            try
            {
                while (reader.Read())
                {
                    ...
                    contactFormMessage.trangThai = int.Parse(reader["TrangThai"].ToString());
                    contactFormMessage.thoiGianPhanHoi = Convert.ToDateTime(reader["ThoiGianPhanHoi"]);
        ...
        {
            totalPages = 1;
            return DBContactFormMessage.GetPage(name, email, moduleGuid, pageNumber, pageSize, out totalPages);
        ...
        {
            totalPages = 1;
            IDataReader reader = DBContactFormMessage.GetPage(name, email, moduleGuid, pageNumber, pageSize, out totalPages);
            return LoadListFromReader(reader);
        }
